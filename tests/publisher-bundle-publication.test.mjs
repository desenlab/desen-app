...
test("[compatibility] preserves the immutable task-time reader projection", () => {
  assert.equal(baseline.artifact.claims.compatibilityReaders.length, 7);
  assert.deepEqual(
    baseline.artifact.claims.compatibilityReaders.map(({ path: relativePath }) => relativePath),
    [
