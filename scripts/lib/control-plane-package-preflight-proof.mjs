...
const M07_T05_AGGREGATE_SUCCESSOR_COMMANDS = Object.freeze({
  check: "pnpm verify:control-plane-local-api",
  test: "pnpm test:control-plane-local-api",
});
const M07_T06_AGGREGATE_SUCCESSOR_COMMANDS = Object.freeze({
  check: "pnpm verify:control-plane-runtime-staging",
  test: "pnpm test:control-plane-runtime-staging",
});
const M07_T07_AGGREGATE_SUCCESSOR_COMMANDS = Object.freeze({
  check: "pnpm verify:control-plane-runtime-activation",
  test: "pnpm test:control-plane-runtime-activation",
});
const M07_T08_AGGREGATE_SUCCESSOR_COMMANDS = Object.freeze({
  check: "pnpm verify:control-plane-runtime-recovery",
  test: "pnpm test:control-plane-runtime-recovery",
});
const M07_T09_AGGREGATE_SUCCESSOR_COMMANDS = Object.freeze({
  check: "pnpm verify:control-plane-runtime-fault-injection",
  test: "pnpm test:control-plane-runtime-fault-injection",
});
const M07_T10_AGGREGATE_SUCCESSOR_COMMANDS = Object.freeze({
  check: "pnpm verify:control-plane-runtime-transition-races",
  test: "pnpm test:control-plane-runtime-transition-races",
});
const M07_T11_AGGREGATE_SUCCESSOR_COMMANDS = Object.freeze({
  check: "pnpm verify:reference-host-web-channel-consumption",
  test: "pnpm test:reference-host-web-channel-consumption",
});
...
function assertAggregateTail(
  ...
  const laterSuccessorIndex = commands.indexOf(reviewedLaterSuccessor);
  const reviewedLaterSuccessorTail =
    successorIndex === currentIndex + 1 &&
    laterSuccessorIndex === successorIndex + 1 &&
    terminalIndex === laterSuccessorIndex + 1 &&
    commands.lastIndexOf(reviewedSuccessor) === successorIndex &&
    commands.lastIndexOf(reviewedLaterSuccessor) === laterSuccessorIndex;
  const newestSuccessorIndex = commands.indexOf(reviewedNewestSuccessor);
  const reviewedNewestSuccessorTail =
    successorIndex === currentIndex + 1 &&
    laterSuccessorIndex === successorIndex + 1 &&
    newestSuccessorIndex === laterSuccessorIndex + 1 &&
    terminalIndex === newestSuccessorIndex + 1 &&
    commands.lastIndexOf(reviewedSuccessor) === successorIndex &&
    commands.lastIndexOf(reviewedLaterSuccessor) === laterSuccessorIndex &&
    commands.lastIndexOf(reviewedNewestSuccessor) === newestSuccessorIndex;
  const latestSuccessorIndex = commands.indexOf(reviewedLatestSuccessor);
  const reviewedLatestSuccessorTail =
    successorIndex === currentIndex + 1 &&
    laterSuccessorIndex === successorIndex + 1 &&
    newestSuccessorIndex === laterSuccessorIndex + 1 &&
    latestSuccessorIndex === newestSuccessorIndex + 1 &&
    terminalIndex === latestSuccessorIndex + 1 &&
    commands.lastIndexOf(reviewedSuccessor) === successorIndex &&
    commands.lastIndexOf(reviewedLaterSuccessor) === laterSuccessorIndex &&
    commands.lastIndexOf(reviewedNewestSuccessor) === newestSuccessorIndex &&
    commands.lastIndexOf(reviewedLatestSuccessor) === latestSuccessorIndex;
  const currentSuccessorIndex = commands.indexOf(reviewedCurrentSuccessor);
  const reviewedCurrentSuccessorTail =
    ...
    commands.lastIndexOf(reviewedNewestSuccessor) === newestSuccessorIndex &&
    commands.lastIndexOf(reviewedLatestSuccessor) === latestSuccessorIndex &&
    commands.lastIndexOf(reviewedCurrentSuccessor) === currentSuccessorIndex;
  const faultInjectionSuccessorIndex = commands.indexOf(reviewedFaultInjectionSuccessor);
  const reviewedFaultInjectionSuccessorTail =
    ...
    commands.lastIndexOf(reviewedLatestSuccessor) === latestSuccessorIndex &&
    commands.lastIndexOf(reviewedCurrentSuccessor) === currentSuccessorIndex &&
    commands.lastIndexOf(reviewedFaultInjectionSuccessor) === faultInjectionSuccessorIndex;
  const transitionRaceSuccessorIndex = commands.indexOf(reviewedTransitionRaceSuccessor);
  const reviewedTransitionRaceSuccessorTail =
    successorIndex === currentIndex + 1 &&
    laterSuccessorIndex === successorIndex + 1 &&
    newestSuccessorIndex === laterSuccessorIndex + 1 &&
    latestSuccessorIndex === newestSuccessorIndex + 1 &&
    ...
    commands.lastIndexOf(reviewedCurrentSuccessor) === currentSuccessorIndex &&
    commands.lastIndexOf(reviewedFaultInjectionSuccessor) === faultInjectionSuccessorIndex &&
    commands.lastIndexOf(reviewedTransitionRaceSuccessor) === transitionRaceSuccessorIndex;
  const channelSuccessorIndex = commands.indexOf(reviewedChannelSuccessor);
  const reviewedChannelSuccessorTail =
    successorIndex === currentIndex + 1 &&
    laterSuccessorIndex === successorIndex + 1 &&
    newestSuccessorIndex === laterSuccessorIndex + 1 &&
    latestSuccessorIndex === newestSuccessorIndex + 1 &&
    ...
    commands.lastIndexOf(reviewedFaultInjectionSuccessor) === faultInjectionSuccessorIndex &&
    commands.lastIndexOf(reviewedTransitionRaceSuccessor) === transitionRaceSuccessorIndex &&
    commands.lastIndexOf(reviewedChannelSuccessor) === channelSuccessorIndex;
  if (
    predecessorIndex < 0 ||
    ...
    (!taskTimeTail &&
      ...
      !reviewedLaterSuccessorTail &&
      !reviewedNewestSuccessorTail &&
  ...
  return Object.freeze(
    await Promise.all(
      observed.map(async (name) => {
        ...
        const approvedM07T08 = APPROVED_M07_T08_INDEX_DISTRIBUTION_RECEIPTS[name];
        const observedSha256 = sha256(bytes);
        if (
...
async function registrationProjection(overrides) {
  ...
  assertAggregateTail(
    ...
    M07_T05_AGGREGATE_SUCCESSOR_COMMANDS.check,
    M07_T06_AGGREGATE_SUCCESSOR_COMMANDS.check,
    M07_T07_AGGREGATE_SUCCESSOR_COMMANDS.check,
    M07_T08_AGGREGATE_SUCCESSOR_COMMANDS.check,
    M07_T09_AGGREGATE_SUCCESSOR_COMMANDS.check,
    M07_T10_AGGREGATE_SUCCESSOR_COMMANDS.check,
    M07_T11_AGGREGATE_SUCCESSOR_COMMANDS.check,
  );
  assertAggregateTail(
    ...
    M07_T05_AGGREGATE_SUCCESSOR_COMMANDS.test,
    M07_T06_AGGREGATE_SUCCESSOR_COMMANDS.test,
    M07_T07_AGGREGATE_SUCCESSOR_COMMANDS.test,
    M07_T08_AGGREGATE_SUCCESSOR_COMMANDS.test,
    M07_T09_AGGREGATE_SUCCESSOR_COMMANDS.test,
    M07_T10_AGGREGATE_SUCCESSOR_COMMANDS.test,
    M07_T11_AGGREGATE_SUCCESSOR_COMMANDS.test,
  );
  if (
...
function assertRuntimeReceipt(observedReceipt) {
  const observedPublicModuleKeys = JSON.stringify(observedReceipt.publicModuleKeys);
  const receipt =
    observedPublicModuleKeys === JSON.stringify(APPROVED_M07_T04_PUBLIC_RUNTIME_KEYS) ||
    observedPublicModuleKeys === JSON.stringify(APPROVED_M07_T05_PUBLIC_RUNTIME_KEYS) ||
    observedPublicModuleKeys === JSON.stringify(APPROVED_M07_T06_PUBLIC_RUNTIME_KEYS) ||
    observedPublicModuleKeys === JSON.stringify(APPROVED_M07_T07_PUBLIC_RUNTIME_KEYS) ||
    observedPublicModuleKeys === JSON.stringify(APPROVED_M07_T08_PUBLIC_RUNTIME_KEYS)
