...
const DIST_STATE_BINDING_EDITS_DECLARATION_PATH =
...
const EXPECTED_TEST_AUTHORITY_SHA256 = Object.freeze({
  ...
  [PUBLIC_TEST_PATH]: "f14e09349076b77527183f5e4a945b2a4bb247e3192b75ee023228d5b5bc7e82",
  [PUBLIC_TYPES_PATH]: "04a7b314398424563b765f1de60105c775aa13485c4b8913250edd21bd0f632a",
  [ROOT_TEST_PATH]: "c544dd0082e0ee646f5369582e85f0a4649769d9a1e90247b683423ec7290ce8",
...
const EXPECTED_EVENT_ACTION_EDIT_RUNTIME_EXPORTS = Object.freeze(
  [
...
const EXPECTED_EVENT_ACTION_EDIT_TYPE_EXPORTS = Object.freeze(
  [
    "DesenEditorAction",
...
function verifySourceAndDistributionContract(files, packageManifest) {
  ...
  const structuralEditsSource = declarationInventory(
    files[STRUCTURAL_EDITS_SOURCE_PATH],
    STRUCTURAL_EDITS_SOURCE_PATH,
  );
  const structuralEditsDeclaration = declarationInventory(
    files[DIST_STRUCTURAL_EDITS_DECLARATION_PATH],
    DIST_STRUCTURAL_EDITS_DECLARATION_PATH,
  );
  const structuralEditsRuntime = declarationInventory(
  ...
  const stateBindingEditsSource = declarationInventory(
    files[STATE_BINDING_EDITS_SOURCE_PATH],
    STATE_BINDING_EDITS_SOURCE_PATH,
  );
  const stateBindingEditsDeclaration = declarationInventory(
    files[DIST_STATE_BINDING_EDITS_DECLARATION_PATH],
    DIST_STATE_BINDING_EDITS_DECLARATION_PATH,
  );
  const stateBindingEditsRuntime = declarationInventory(
    files[DIST_STATE_BINDING_EDITS_PATH],
    DIST_STATE_BINDING_EDITS_PATH,
  );
  const eventActionEditsSource = declarationInventory(
    files[EVENT_ACTION_EDITS_SOURCE_PATH],
    EVENT_ACTION_EDITS_SOURCE_PATH,
  );
  const eventActionEditsDeclaration = declarationInventory(
    files[DIST_EVENT_ACTION_EDITS_DECLARATION_PATH],
    DIST_EVENT_ACTION_EDITS_DECLARATION_PATH,
  );
  const eventActionEditsRuntime = declarationInventory(
  ...
  if (
    !exactJson(stateBindingEditsSource.runtime, EXPECTED_STATE_BINDING_EDIT_RUNTIME_EXPORTS) ||
    !exactJson(stateBindingEditsSource.types, EXPECTED_STATE_BINDING_EDIT_TYPE_EXPORTS) ||
    stateBindingEditsSource.missingTsdoc.length !== 0 ||
    !exactJson(stateBindingEditsDeclaration.runtime, EXPECTED_STATE_BINDING_EDIT_RUNTIME_EXPORTS) ||
    !exactJson(stateBindingEditsDeclaration.types, EXPECTED_STATE_BINDING_EDIT_TYPE_EXPORTS) ||
    stateBindingEditsDeclaration.missingTsdoc.length !== 0 ||
    !exactJson(stateBindingEditsRuntime.runtime, EXPECTED_STATE_BINDING_EDIT_RUNTIME_EXPORTS) ||
    stateBindingEditsRuntime.types.length !== 0
  ) {
    fail(
      "EDITOR_SOURCE_DOCUMENT_PUBLIC_API_DRIFT",
      "The additive M08-T05 state/binding-edit module lost its reviewed declarations or TSDoc.",
      {
        sourceRuntime: stateBindingEditsSource.runtime,
        sourceTypes: stateBindingEditsSource.types,
        declarationRuntime: stateBindingEditsDeclaration.runtime,
        declarationTypes: stateBindingEditsDeclaration.types,
        emittedRuntime: stateBindingEditsRuntime.runtime,
      },
    );
  }
  if (
    !exactJson(eventActionEditsSource.runtime, EXPECTED_EVENT_ACTION_EDIT_RUNTIME_EXPORTS) ||
    !exactJson(eventActionEditsSource.types, EXPECTED_EVENT_ACTION_EDIT_TYPE_EXPORTS) ||
    eventActionEditsSource.missingTsdoc.length !== 0 ||
    !exactJson(eventActionEditsDeclaration.runtime, EXPECTED_EVENT_ACTION_EDIT_RUNTIME_EXPORTS) ||
    !exactJson(eventActionEditsDeclaration.types, EXPECTED_EVENT_ACTION_EDIT_TYPE_EXPORTS) ||
    eventActionEditsDeclaration.missingTsdoc.length !== 0 ||
    !exactJson(eventActionEditsRuntime.runtime, EXPECTED_EVENT_ACTION_EDIT_RUNTIME_EXPORTS) ||
    eventActionEditsRuntime.types.length !== 0
  ) {
    fail(
      "EDITOR_SOURCE_DOCUMENT_PUBLIC_API_DRIFT",
      "The additive M08-T06 event/action-edit module lost its reviewed declarations or TSDoc.",
      {
        sourceRuntime: eventActionEditsSource.runtime,
        sourceTypes: eventActionEditsSource.types,
        declarationRuntime: eventActionEditsDeclaration.runtime,
        declarationTypes: eventActionEditsDeclaration.types,
        emittedRuntime: eventActionEditsRuntime.runtime,
      },
    );
  }
  if (
  ...
  if (
    ...
    !exactJson(structuralEditsDeclaration.runtime, EXPECTED_STRUCTURAL_EDIT_RUNTIME_EXPORTS) ||
    !exactJson(structuralEditsDeclaration.types, EXPECTED_STRUCTURAL_EDIT_TYPE_EXPORTS) ||
    structuralEditsDeclaration.missingTsdoc.length !== 0 ||
    !exactJson(structuralEditsRuntime.runtime, EXPECTED_STRUCTURAL_EDIT_RUNTIME_EXPORTS) ||
    structuralEditsRuntime.types.length !== 0
  ) {
    fail(
      "EDITOR_SOURCE_DOCUMENT_PUBLIC_API_DRIFT",
      "The additive M08-T03 structural-edit module lost its reviewed declarations or TSDoc.",
      {
        sourceRuntime: structuralEditsSource.runtime,
        sourceTypes: structuralEditsSource.types,
        declarationRuntime: structuralEditsDeclaration.runtime,
        declarationTypes: structuralEditsDeclaration.types,
        emittedRuntime: structuralEditsRuntime.runtime,
      },
    );
  }
  ...
  for (const sourceFile of [
    source.sourceFile,
    structuralEditsSource.sourceFile,
    structuralEditsDeclaration.sourceFile,
    structuralEditsRuntime.sourceFile,
    stateBindingEditsSource.sourceFile,
    stateBindingEditsDeclaration.sourceFile,
    stateBindingEditsRuntime.sourceFile,
  ...
  return Object.freeze({
    ...
    additiveSuccessors: Object.freeze([
      ...
      Object.freeze({
        ...
        runtimePath: DIST_STATE_BINDING_EDITS_PATH,
        declarationPath: DIST_STATE_BINDING_EDITS_DECLARATION_PATH,
