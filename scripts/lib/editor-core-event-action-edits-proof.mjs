...
function verifyBoundary(files) {
  ...
  return deepFreeze({
    ...
    additiveTypeExports: [...PERSISTENCE_TYPE_EXPORTS, ...CONTINUOUS_VALIDATION_TYPE_EXPORTS].sort(
      compareText,
    ),
    additiveSuccessor: {
      task: "M08-T08",
...
/** Captures own-data options and rebuilds M08-T06 from freshly authenticated inputs. */
...
async function buildCapturedEvidence(options) {
  ...
  const currentCompatibility = deepFreeze({
    ...
    nonclaims: [
      ...
      "M08_T08_PERSISTENCE_SUCCESSOR_BYTES_ARE_COMPATIBILITY_ONLY_NOT_T06_CLAIM_AUTHORITY",
      "M08_T09_CONTINUOUS_VALIDATION_SUCCESSOR_BYTES_ARE_COMPATIBILITY_ONLY_NOT_T06_CLAIM_AUTHORITY",
      "ACTION_EXECUTION_AND_RUNTIME_TURNS",
      "UNDO_REDO_SELECTION_AND_VIEWPORT_POLICY",
      "M08_T10_TERMINAL_BYTES_ARE_COMPATIBILITY_ONLY_NOT_T06_CLAIM_AUTHORITY",
...
export async function verifyEditorCoreEventActionEditsEvidence(rawOptions = undefined) {
  ...
  readProofDocumentPin(decodeUtf8(preflightProofBytes, "M08-T06 proof document"));
