...
const APPROVED_CURRENT_COMPATIBILITY_RECEIPTS = Object.freeze({
  [EXECUTION_PREFLIGHT_COMPATIBILITY_READER]:
    APPROVED_COMPATIBILITY_RECEIPT_HISTORY[EXECUTION_PREFLIGHT_COMPATIBILITY_READER][9],
  [EXECUTION_PREFLIGHT_COMPATIBILITY_ROOT_TEST]:
    APPROVED_COMPATIBILITY_RECEIPT_HISTORY[EXECUTION_PREFLIGHT_COMPATIBILITY_ROOT_TEST][9],
});
