...
const APPROVED_CURRENT_M05_COMPATIBILITY_RECEIPTS = Object.freeze({
  [M05_SOURCE_AUDIT_PROOF_RELATIVE_PATH]:
    APPROVED_M05_COMPATIBILITY_RECEIPT_HISTORY[M05_SOURCE_AUDIT_PROOF_RELATIVE_PATH][3],
  [M05_SOURCE_AUDIT_TEST_RELATIVE_PATH]:
    APPROVED_M05_COMPATIBILITY_RECEIPT_HISTORY[M05_SOURCE_AUDIT_TEST_RELATIVE_PATH][3],
});
