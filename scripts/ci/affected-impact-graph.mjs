...
const REVIEWED_PREREQUISITES = SAFE_OBJECT_FREEZE(
  [
    ...
    ["desen-app-named-slot-authoring", ["desen-app-structured-inspector"]],
    [
    ...
    ["desen-app-empty-project-browser-e2e", ["desen-app-publish-activation"]],
    ["desen-app-browser-e2e-workspace-compatibility", ["desen-app-empty-project-browser-e2e"]],
    ...
    ["desen-app-failure-fixture", ["desen-app-input-pending-fixture"]],
    [
    ...
    ["m10a-t13", []],
    ["m10a-t14", []],
    ["m10a-t15", ["m10a-t02", "m10a-t03", "m10a-t12", "m10a-t13", "m10a-t14"]],
...
export function createAffectedImpactClosure(ownerProofUnitIds) {
  ...
  if (proofUnitIds.includes("m10a-t03")) {
    conditionalPrefixNodeIds.push("design-system-authoring-public-package-contract");
  }
  if (proofUnitIds.includes("m10a-t04")) {
    conditionalPrefixNodeIds.push("design-system-release-public-package-contract");
  }
  if (
    ...
    proofUnitIds.includes("m10a-t09") ||
    proofUnitIds.includes("m10a-t12")
  ) {
