...
test("owns exactly 246 steps across the eight reviewed execution classes", () => {
  ...
  assert.equal(ALL_STEP_IDS.length, 246);
  assert.equal(new Set(ALL_STEP_IDS).size, 246);
  ...
  assert.deepEqual(classifyWorkloadStateMetadata("design-system-release-public-package-contract"), {
    schemaVersion: 2,
    stepId: "design-system-release-public-package-contract",
    executionClass: "WORKSPACE_OUTPUT_EXCLUSIVE",
    workspaceReads: ["."],
    workspaceWrites: ["."],
    tempPolicy: "NONE",
...
test("pins the exact twelve read-only, two browser, and sole workspace-temp proof ids", () => {
  assert.equal(PROOF_IDS.length, 116);
  assert.equal(new Set(PROOF_IDS).size, 116);
  const proofPairs = PROOF_IDS.map((proofId) => classifyProofPairState(proofId));
  assert.equal(proofPairs.filter(({ barrier }) => !barrier).length, 103);
  ...
  assert.deepEqual(classifyProofPairState("desen-app-source-persistence"), {
    proofId: "desen-app-source-persistence",
    barrier: false,
    verifier: {
      schemaVersion: 2,
      stepId: "verify-desen-app-source-persistence",
      executionClass: "PROOF_READ_ONLY",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "NONE",
    ...
    rootTest: {
      schemaVersion: 2,
      stepId: "test-desen-app-source-persistence",
      executionClass: "PROOF_OS_TEMP_ISOLATED",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "RUNNER_SCOPED_OS",
      tempKey: "test-desen-app-source-persistence",
      ports: [],
      childProcessPolicy: "NODE_TEST_HARNESS",
      nativeAddonPolicy: "NONE",
      filesystemCompatibilityPolicy: "NONE",
  ...
  assert.deepEqual(classifyProofPairState("desen-app-node-linked-diagnostics"), {
    proofId: "desen-app-node-linked-diagnostics",
    barrier: false,
    verifier: {
      schemaVersion: 2,
      stepId: "verify-desen-app-node-linked-diagnostics",
      executionClass: "PROOF_READ_ONLY",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "NONE",
    ...
    rootTest: {
      schemaVersion: 2,
      stepId: "test-desen-app-node-linked-diagnostics",
      executionClass: "PROOF_OS_TEMP_ISOLATED",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "RUNNER_SCOPED_OS",
      tempKey: "test-desen-app-node-linked-diagnostics",
      ports: [],
      childProcessPolicy: "NODE_TEST_HARNESS",
      nativeAddonPolicy: "NONE",
      filesystemCompatibilityPolicy: "NONE",
  ...
  assert.deepEqual(classifyProofPairState("desen-app-publish-activation"), {
    proofId: "desen-app-publish-activation",
    barrier: false,
    verifier: {
      schemaVersion: 2,
      stepId: "verify-desen-app-publish-activation",
      executionClass: "PROOF_READ_ONLY",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "NONE",
    ...
    rootTest: {
      schemaVersion: 2,
      stepId: "test-desen-app-publish-activation",
      executionClass: "PROOF_OS_TEMP_ISOLATED",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "RUNNER_SCOPED_OS",
      tempKey: "test-desen-app-publish-activation",
      ports: [],
      childProcessPolicy: "NODE_TEST_HARNESS",
      nativeAddonPolicy: "NONE",
      filesystemCompatibilityPolicy: "NONE",
  ...
  assert.deepEqual(classifyProofPairState("desen-app-empty-project-browser-e2e"), {
    proofId: "desen-app-empty-project-browser-e2e",
    barrier: false,
    verifier: {
      schemaVersion: 2,
      stepId: "verify-desen-app-empty-project-browser-e2e",
      executionClass: "PROOF_READ_ONLY",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "NONE",
    ...
    rootTest: {
      schemaVersion: 2,
      stepId: "test-desen-app-empty-project-browser-e2e",
      executionClass: "PROOF_OS_TEMP_ISOLATED",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "RUNNER_SCOPED_OS",
      tempKey: "test-desen-app-empty-project-browser-e2e",
      ports: [],
      childProcessPolicy: "NODE_TEST_HARNESS",
      nativeAddonPolicy: "NONE",
      filesystemCompatibilityPolicy: "NONE",
  ...
  assert.deepEqual(classifyProofPairState("desen-app-browser-e2e-workspace-compatibility"), {
    proofId: "desen-app-browser-e2e-workspace-compatibility",
    barrier: false,
    verifier: {
      schemaVersion: 2,
      stepId: "verify-desen-app-browser-e2e-workspace-compatibility",
      executionClass: "PROOF_READ_ONLY",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "NONE",
    ...
    rootTest: {
      schemaVersion: 2,
      stepId: "test-desen-app-browser-e2e-workspace-compatibility",
      executionClass: "PROOF_OS_TEMP_ISOLATED",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "RUNNER_SCOPED_OS",
      tempKey: "test-desen-app-browser-e2e-workspace-compatibility",
      ports: [],
      childProcessPolicy: "NODE_TEST_HARNESS",
      nativeAddonPolicy: "NONE",
      filesystemCompatibilityPolicy: "NONE",
  ...
  assert.deepEqual(classifyProofPairState("desen-app-user-created-blank-project"), {
    proofId: "desen-app-user-created-blank-project",
    barrier: false,
    verifier: {
      schemaVersion: 2,
      stepId: "verify-desen-app-user-created-blank-project",
      executionClass: "PROOF_READ_ONLY",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "NONE",
    ...
    rootTest: {
      schemaVersion: 2,
      stepId: "test-desen-app-user-created-blank-project",
      executionClass: "PROOF_OS_TEMP_ISOLATED",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "RUNNER_SCOPED_OS",
      tempKey: "test-desen-app-user-created-blank-project",
      ports: [],
      childProcessPolicy: "NODE_TEST_HARNESS",
      nativeAddonPolicy: "NONE",
      filesystemCompatibilityPolicy: "NONE",
  ...
  assert.deepEqual(classifyProofPairState("desen-app-visual-behavior-authoring"), {
    proofId: "desen-app-visual-behavior-authoring",
    barrier: false,
    verifier: {
      schemaVersion: 2,
      stepId: "verify-desen-app-visual-behavior-authoring",
      executionClass: "PROOF_READ_ONLY",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "NONE",
    ...
    rootTest: {
      schemaVersion: 2,
      stepId: "test-desen-app-visual-behavior-authoring",
      executionClass: "PROOF_OS_TEMP_ISOLATED",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "RUNNER_SCOPED_OS",
      tempKey: "test-desen-app-visual-behavior-authoring",
      ports: [],
      childProcessPolicy: "NODE_TEST_HARNESS",
      nativeAddonPolicy: "NONE",
      filesystemCompatibilityPolicy: "NONE",
  ...
  assert.deepEqual(classifyProofPairState("desen-app-evergreen-product-composition"), {
    proofId: "desen-app-evergreen-product-composition",
    barrier: false,
    verifier: {
      schemaVersion: 2,
      stepId: "verify-desen-app-evergreen-product-composition",
      executionClass: "PROOF_READ_ONLY",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "NONE",
    ...
    rootTest: {
      schemaVersion: 2,
      stepId: "test-desen-app-evergreen-product-composition",
      executionClass: "PROOF_OS_TEMP_ISOLATED",
      workspaceReads: ["."],
      workspaceWrites: [],
      tempPolicy: "RUNNER_SCOPED_OS",
      tempKey: "test-desen-app-evergreen-product-composition",
      ports: [],
      childProcessPolicy: "NODE_TEST_HARNESS",
      nativeAddonPolicy: "NONE",
      filesystemCompatibilityPolicy: "NONE",
...
test("T04 real-host evidence readers remain passive and acquire no listener authority", () => {
  const pair = classifyProofPairState("desen-app-success-host-operation");
  assert.equal(pair.barrier, false);
  assert.equal(pair.verifier.executionClass, "PROOF_READ_ONLY");
  assert.equal(pair.verifier.childProcessPolicy, "NONE");
...
test("M10A browser proofs own distinct fixed-port exclusive verifier authorities", async (context) => {
  assert.deepEqual(BROWSER_EXCLUSIVE_VERIFIER_STEP_IDS, ["verify-m10a-t06", "verify-m10a-t03"]);
  const cases = [
    {
      proofId: "m10a-t06",
      stepId: "verify-m10a-t06",
      port: 4_189,
      envKey: "DESEN_M10A_T06_PROOF_TEMP",
    },
    {
      proofId: "m10a-t03",
  ...
  const historicalT05 = classifyProofPairState("m10a-t05");
  assert.equal(historicalT05.barrier, false);
  assert.equal(historicalT05.verifier.executionClass, "PROOF_READ_ONLY");
  assert.deepEqual(historicalT05.verifier.ports, []);
  assert.equal(historicalT05.rootTest.executionClass, "PROOF_READ_ONLY");
  assert.equal(historicalT05.rootTest.tempPolicy, "NONE");

  assert.throws(
    () => classifyWorkloadStateMetadata("verify-m10a-t06-copy"),
  ...
  for (const mutate of [
    ...
    const forged = mutableMetadata("verify-m10a-t06");
    mutate(forged);
    assert.throws(
      () => validateWorkloadStateMetadata("verify-m10a-t06", forged),
  ...
  const isolation = await createProofStepIsolationContext({
    workspaceRoot,
    workload: "verify-m10a-t06",
    baseEnvironment: {
      PATH: process.env.PATH,
      NODE_OPTIONS: "   ",
      DESEN_M10A_T06_PROOF_TEMP: "/tmp/forged",
      DESEN_CI_WORKSPACE_ROOT: "/tmp/forged",
    },
  });
  context.after(() => isolation.dispose());
  assert.equal(isolation.env.DESEN_M10A_T06_PROOF_TEMP, isolation.tempRoot);
  assert.equal("NODE_OPTIONS" in isolation.env, false);
  assert.equal("DESEN_CI_WORKSPACE_ROOT" in isolation.env, false);
  assert.equal(isolation.env.DESEN_CI_STEP_ID, "verify-m10a-t06");
  ...
  const t03Isolation = await createProofStepIsolationContext({
    ...
    baseEnvironment: {
      ...
      DESEN_M10A_T06_PROOF_TEMP: "/tmp/forged-t06",
    },
  });
...
test("T05 live Vite verifier and read-only root reader retain the same native build authority", () => {
  ...
  assert.equal(pair.verifier.tempPolicy, "RUNNER_SCOPED_OS");
  assert.equal(pair.verifier.nativeAddonPolicy, "DESEN_APP_PUBLISHED_HOST_UPDATE_VITE");
...
test("T06 live Vite and Publisher probes inherit bounded temp authority without listeners", () => {
  const pair = classifyProofPairState("desen-app-invalid-publication");
  assert.equal(pair.barrier, false);
  assert.equal(pair.verifier.executionClass, "PROOF_OS_TEMP_ISOLATED");
  assert.equal(pair.verifier.childProcessPolicy, "VERIFIER_RUNTIME_PROBE");
  assert.equal(pair.rootTest.executionClass, "PROOF_OS_TEMP_ISOLATED");
  ...
  for (const step of [pair.verifier, pair.rootTest]) {
    ...
    assert.equal(step.nativeAddonPolicy, "DESEN_APP_INVALID_PUBLICATION_VITE");
    assert.deepEqual(step.ports, []);
    assert.deepEqual(step.workspaceWrites, []);
    assert.equal(step.filesystemCompatibilityPolicy, "NONE");
  }
...
test("T08 repeatable-demo probes retain only Vite/SQLite and runner-owned temporary authority", () => {
  const pair = classifyProofPairState("desen-app-repeatable-demo");
  assert.equal(pair.barrier, false);
  assert.equal(pair.verifier.childProcessPolicy, "VERIFIER_RUNTIME_PROBE");
  assert.equal(pair.rootTest.childProcessPolicy, "NODE_TEST_HARNESS");
  for (const step of [pair.verifier, pair.rootTest]) {
    assert.equal(step.executionClass, "PROOF_OS_TEMP_ISOLATED");
    assert.equal(step.tempPolicy, "RUNNER_SCOPED_OS");
    assert.equal(step.nativeAddonPolicy, "DESEN_APP_REPEATABLE_DEMO_VITE_SQLITE");
    assert.deepEqual(step.ports, []);
    assert.deepEqual(step.workspaceWrites, []);
    assert.equal(step.filesystemCompatibilityPolicy, "NONE");
    assert.equal(LOOPBACK_CHILD_LISTENER_VERIFIER_STEP_IDS.includes(step.stepId), false);
...
test("T07 and T08 verifiers and roots load real Vite/SQLite while unrelated steps deny both", async (context) => {
  const steps = await Promise.all(
    [
      "verify-desen-app-last-known-good-recovery",
      "test-desen-app-last-known-good-recovery",
      "verify-desen-app-repeatable-demo",
      "test-desen-app-repeatable-demo",
    ].map((workload) =>
      createProofStepIsolationContext({ workspaceRoot: REPOSITORY_ROOT, workload }),
    ),
  );
...
test("build-output seals cover every exact app/package dist and Turbo root", async (context) => {
  assert.equal(BUILD_OUTPUT_ROOTS.length, 49);
  assert.equal(new Set(BUILD_OUTPUT_ROOTS).size, 49);
  ...
  assert.equal(BUILD_OUTPUT_ROOTS.includes("packages/design-system-release/dist"), true);
