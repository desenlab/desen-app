                                  ...
                                  : PUBLISHED_HOST_UPDATE_RESEALED_READER_INDEXES.includes(index)
                                    ...
                                    : ARCHIVE_REDACTION_RESEALED_READER_INDEXES.includes(index)
                                      ...
                                      : FRESH_PROOF_PERFORMANCE_RESEALED_READER_INDEXES.includes(
                                        ...
                                        : reader;
  const expectedCurrent = M10A_T14_HISTORICAL_EDITOR_CORE_RESEALED_READER_INDEXES.includes(index)
                                                ...
                                                : M10A_T12_T09_HISTORY_RESEALED_READER_INDEXES.includes(
                                                  ...
                                                  : M10A_T11_NODE_LINKED_DIAGNOSTICS_BRIDGE_RESEALED_READER_INDEXES.includes(
                                                    ...
                                                    : M10A_T11_PERFORMANCE_RESEALED_READER_INDEXES.includes(
                                                      ...
                                                      ? baselineManifest.checkpoints[108].readers[
                                                          index
                                                        ]
                                                      : M10A_T11_CLEANUP_RESEALED_READER_INDEXES.includes(
                                                            index,
                                                          )
                                                        ? baselineManifest.checkpoints[107].readers[
                                                            index
                                                          ]
                                                        : M10A_T11_RESEALED_READER_INDEXES.includes(
                                                          ...
                                                          : M10A_T10_REPEATABLE_DEMO_RESEALED_READER_INDEXES.includes(
                                                            ...
                                                            : M10A_T10_RECOVERY_RESEALED_READER_INDEXES.includes(
                                                              ...
                                                              ? baselineManifest.checkpoints[104]
                                                                  .readers[index]
                                                              : M10A_T10_REAL_ADAPTER_CANVAS_RESEALED_READER_INDEXES.includes(
                                                                    index,
                                                                  )
                                                                ? baselineManifest.checkpoints[103]
                                                                    .readers[index]
...
test("the reviewed chain authenticates its immutable genesis and current readers", async () => {
  ...
  assert.equal(manifest.checkpoints.length, 134);
  ...
  assert.equal(manifest.headSha256, PROOF_READER_CHECKPOINT_REVIEWED_CHAIN_SHA256[133]);
  assert.equal(PROOF_READER_CHECKPOINT_REVIEWED_CHAIN_SHA256.length, 134);
  assert.equal(
    PROOF_READER_CHECKPOINT_REVIEWED_CHAIN_SHA256[7],
  ...
  assert.deepEqual(
    ...
    [
      ...
      74, 74, 74, 74, 75, 75, 75, 75, 75, 75, 76, 76, 76, 76, 76, 76, 76, 76,
    ],
  );
