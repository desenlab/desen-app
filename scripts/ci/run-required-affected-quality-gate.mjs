...
/** Fixed soft deadline kept below the workflow's independent 25-minute hard timeout. */
...
function selectedRegions(selection, nodeById) {
  ...
  if (selection.affectedProofUnitIds.includes("m10a-t03")) {
    conditionalPrefixIds.push("design-system-authoring-public-package-contract");
  }
  ...
  if (
    selection.affectedProofUnitIds.includes("m10a-t07") ||
    selection.affectedProofUnitIds.includes("m10a-t08") ||
    selection.affectedProofUnitIds.includes("m10a-t09")
  ) {
          ...
          : proofId === "m10a-t02"
            ...
            : proofId === "m10a-t03"
              ...
              : proofId === "m10a-t04"
                ...
                : proofId === "m10a-t07" || proofId === "m10a-t08" || proofId === "m10a-t09"
