...
const M10A_T01_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
  // The complete accepted successor from I07-04 through M10A-T01 remains independently reversible.
...
const M10A_T02_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T03_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T04_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T05_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T06_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T08_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T09_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T10_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T11_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T12_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T13_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T15_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T16_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T18_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
  "apps/desen-app/src/design-system-library.ts",
  "apps/desen-app/test/design-system-library.test.ts",
  "scripts/lib/m10a-t18-legacy-input-receipts.mjs",
]);
const M10A_T19_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
  "apps/desen-app/src/connection-intent-drafts.ts",
...
const M10A_T21_SUCCESSOR_ADDED_TRACKED_PATHS = Object.freeze([
...
const M10A_T01_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
...
const M10A_T02_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
...
const M10A_T03_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
...
const M10A_T04_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
...
const M10A_T05_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
...
const M10A_T07_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
  trackedPathCount: 1765,
  trackedPathSetSha256: "d125df0ee189ff9552ebc2048756fd6467f6e84a16c5e0c041d0b14dd5f8b1a3",
  proofOwnedPathCount: 234,
  categoryCounts: Object.freeze({
    PROOF_UNIT: 234,
    CI_POLICY: 48,
    DEPENDENCY_POLICY: 38,
...
const M10A_T08_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
  trackedPathCount: 1785,
  trackedPathSetSha256: "023365a3c0f827db09a2d09ae57f3ede20801edda6dd1f7516155524b1f4bc95",
  proofOwnedPathCount: 236,
  categoryCounts: Object.freeze({
    PROOF_UNIT: 236,
    CI_POLICY: 48,
    DEPENDENCY_POLICY: 38,
    FROZEN_INPUT: 167,
    PACKAGE_OR_APPLICATION: 712,
    SHARED_PROOF_INFRASTRUCTURE: 405,
    PROJECT_DOCUMENTATION: 168,
    REPOSITORY_POLICY: 11,
  }),
  ownershipSha256: "b5c0a57947c9d4acb2d6eea0f84fcd04eaa0dea2b1290253978a896f4385d27f",
});
const M10A_T09_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
...
const M10A_T11_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
...
const M10A_T12_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
  trackedPathCount: 1841,
  trackedPathSetSha256: "7f37cdbb1f281d239c936fb4451259a8c3a7ace3ff43a26f82eda6152f8640b9",
  proofOwnedPathCount: 240,
  categoryCounts: Object.freeze({
    PROOF_UNIT: 240,
    CI_POLICY: 48,
    DEPENDENCY_POLICY: 38,
...
const M10A_T13_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
  trackedPathCount: 1857,
  trackedPathSetSha256: "1195c61007e31713b2aa72deff4c7c118083854b6e7fdafcd10873a90eb44859",
  proofOwnedPathCount: 242,
  categoryCounts: Object.freeze({
    PROOF_UNIT: 242,
    CI_POLICY: 48,
...
const M10A_T16_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
  trackedPathCount: 1916,
  trackedPathSetSha256: "15dc9ded69ada4e93eb1ff61bc73d3062f7dba01ec6b5f55f1f5e0dc6dfa9d9b",
  proofOwnedPathCount: 246,
  categoryCounts: Object.freeze({
    PROOF_UNIT: 246,
    CI_POLICY: 50,
...
const M10A_T18_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
  trackedPathCount: 1923,
  trackedPathSetSha256: "53d5209cbf9f5015dfadc257d367d60e43f39ff7c34e951fc856eff726ad9827",
  proofOwnedPathCount: 246,
  categoryCounts: Object.freeze({
    PROOF_UNIT: 246,
    CI_POLICY: 50,
    DEPENDENCY_POLICY: 39,
    FROZEN_INPUT: 172,
    PACKAGE_OR_APPLICATION: 807,
    SHARED_PROOF_INFRASTRUCTURE: 421,
    PROJECT_DOCUMENTATION: 177,
    REPOSITORY_POLICY: 11,
  }),
...
const M10A_T20_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
  trackedPathCount: 1931,
  trackedPathSetSha256: "16d00491f4c962864b6aacd9fdeb9d656c4efcfb25b90caa3cbe8cd7af3bd2c7",
  proofOwnedPathCount: 246,
  categoryCounts: Object.freeze({
    PROOF_UNIT: 246,
    CI_POLICY: 50,
  ...
  ownershipSha256: "97e749a7c2b29a106a321ecf16961cb5c8f6695f15a3b104c0d387871ac6e2f8",
});
const M10A_T21_SUCCESSOR_OWNERSHIP_REVIEW = Object.freeze({
  trackedPathCount: 1933,
  trackedPathSetSha256: "04578b99680a0589ca7cf9bdf863667467877c08dd6ce8d4972a0368180c1f8e",
  proofOwnedPathCount: 246,
  categoryCounts: Object.freeze({
    PROOF_UNIT: 246,
    CI_POLICY: 50,
  ...
  ownershipSha256: "7fdce0ac23918691ff71d0c04131c0eef54014af1dc9741461bb1eb5403545ec",
});
...
const CURRENT_PROOF_READER_CHECKPOINT = Object.freeze({
  profile: "desen.ci.proof-reader-checkpoints.v1",
  sequence: 157,
  headSha256: "4745377e6493ae3444ca1f327a2283fdb0c1f0b28898e8a1fc97e73cdcb0086b",
...
function createBoundaryOwnershipDelta(rawBoundary) {
  ...
  let t20SuccessorPaths = currentSuccessorPaths;
  if (isDeepStrictEqual(successorReview, M10A_T21_SUCCESSOR_OWNERSHIP_REVIEW)) {
    if (
      M10A_T21_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 2 ||
      new Set(M10A_T21_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 2 ||
      M10A_T21_SUCCESSOR_ADDED_TRACKED_PATHS.some(
        (trackedPath) => !currentSuccessorPaths.includes(trackedPath),
      )
    ) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated M10A-T21 successor must include exactly the two reviewed added paths.",
      );
    }
    t20SuccessorPaths = currentSuccessorPaths.filter(
      (trackedPath) => !M10A_T21_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
    );
  }
  let t19SuccessorPaths = t20SuccessorPaths;
  if (isDeepStrictEqual(successorReview, M10A_T20_SUCCESSOR_OWNERSHIP_REVIEW)) {
    if (
      M10A_T20_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 2 ||
      new Set(M10A_T20_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 2 ||
      M10A_T20_SUCCESSOR_ADDED_TRACKED_PATHS.some(
        (trackedPath) => !t20SuccessorPaths.includes(trackedPath),
      )
    ) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated M10A-T20 successor must include exactly the two reviewed added paths.",
      );
    }
    t19SuccessorPaths = t20SuccessorPaths.filter(
  ...
  if (
    ...
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The authenticated boundary does not reproduce the reviewed M10A-T17 ownership successor.",
    );
  }
  if (
  ...
  if (
    ...
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T17 append must reproduce the reviewed T16 successor.",
    );
  }
  if (
  ...
  const localPreflightSuccessorPaths = successorPaths.filter(
    (trackedPath) => !M10A_T15_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  if (
    !isDeepStrictEqual(
      calculateAffectedWorkloadOwnershipReview(localPreflightSuccessorPaths),
      LOCAL_PREFLIGHT_SUCCESSOR_OWNERSHIP_REVIEW,
    )
  ) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact T15 append must reproduce the complete local-preflight predecessor.",
    );
  }
  if (
  ...
  const m10aT14SuccessorPaths = localPreflightSuccessorPaths.filter(
  ...
  if (!isDeepStrictEqual(m10aT13SuccessorReview, M10A_T13_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T14 append does not reproduce the reviewed M10A-T13 successor.",
    );
  }
  const m10aT12SuccessorPaths = m10aT13SuccessorPaths.filter(
    (trackedPath) => !M10A_T13_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  const m10aT12SuccessorReview = calculateAffectedWorkloadOwnershipReview(m10aT12SuccessorPaths);
  if (!isDeepStrictEqual(m10aT12SuccessorReview, M10A_T12_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T13 append does not reproduce the reviewed M10A-T12 successor.",
    );
  }
  if (
    M10A_T12_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 24 ||
    new Set(M10A_T12_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 24
  ) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The reviewed M10A-T12 successor path append is not exactly twenty-four unique paths.",
    );
  }
  for (const trackedPath of M10A_T12_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT12SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated boundary omitted one exact M10A-T12 successor path.",
        { path: trackedPath },
      );
    }
  }
  const m10aT11SuccessorPaths = m10aT12SuccessorPaths.filter(
    (trackedPath) => !M10A_T12_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  const m10aT11SuccessorReview = calculateAffectedWorkloadOwnershipReview(m10aT11SuccessorPaths);
  if (!isDeepStrictEqual(m10aT11SuccessorReview, M10A_T11_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T12 append does not reproduce the reviewed M10A-T11 successor.",
    );
  }
  if (
    M10A_T11_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 5 ||
    new Set(M10A_T11_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 5
  ) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The reviewed M10A-T11 successor path append is not exactly five unique paths.",
    );
  }
  for (const trackedPath of M10A_T11_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT11SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated boundary omitted one exact M10A-T11 successor path.",
        { path: trackedPath },
      );
    }
  }
  const m10aT10SuccessorPaths = m10aT11SuccessorPaths.filter(
    (trackedPath) => !M10A_T11_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  const m10aT10SuccessorReview = calculateAffectedWorkloadOwnershipReview(m10aT10SuccessorPaths);
  if (!isDeepStrictEqual(m10aT10SuccessorReview, M10A_T10_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T11 append does not reproduce the reviewed M10A-T10 successor.",
    );
  }
  if (
  ...
  for (const trackedPath of M10A_T10_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT10SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated boundary omitted one exact M10A-T10 successor path.",
        { path: trackedPath },
      );
    }
  }
  ...
  if (!isDeepStrictEqual(m10aT09SuccessorReview, M10A_T09_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T10 append does not reproduce the reviewed M10A-T09 successor.",
    );
  }
  if (
    M10A_T09_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 20 ||
    new Set(M10A_T09_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 20
  ) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The reviewed M10A-T09 successor path append is not exactly 20 unique paths.",
    );
  }
  for (const trackedPath of M10A_T09_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT09SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated boundary omitted one exact M10A-T09 successor path.",
        { path: trackedPath },
      );
    }
  }
  const m10aT08SuccessorPaths = m10aT09SuccessorPaths.filter(
    (trackedPath) => !M10A_T09_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  const m10aT08SuccessorReview = calculateAffectedWorkloadOwnershipReview(m10aT08SuccessorPaths);
  if (!isDeepStrictEqual(m10aT08SuccessorReview, M10A_T08_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T09 append does not reproduce the reviewed M10A-T08 successor.",
    );
  }
  if (
    M10A_T08_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 20 ||
    new Set(M10A_T08_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 20
  ) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The reviewed M10A-T08 successor path append is not exactly 20 unique paths.",
    );
  }
  for (const trackedPath of M10A_T08_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT08SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated M10A-T08 successor omitted one exact M10A-T08 path.",
        { path: trackedPath },
      );
    }
  }
  const m10aT07SuccessorPaths = m10aT08SuccessorPaths.filter(
    (trackedPath) => !M10A_T08_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  const m10aT07SuccessorReview = calculateAffectedWorkloadOwnershipReview(m10aT07SuccessorPaths);
  if (!isDeepStrictEqual(m10aT07SuccessorReview, M10A_T07_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T08 append does not reproduce the reviewed M10A-T07 successor.",
    );
  }
  if (
  ...
  const m10aT06SuccessorPaths = m10aT07SuccessorPaths.filter(
  ...
  if (
    ...
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The reviewed M10A-T06 successor path append is not exactly 24 unique paths.",
    );
  }
  ...
  if (!isDeepStrictEqual(m10aT05SuccessorReview, M10A_T05_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T06 append does not reproduce the reviewed M10A-T05 successor.",
    );
  }
  if (
    M10A_T05_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 11 ||
    new Set(M10A_T05_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 11
  ) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The reviewed M10A-T05 successor path append is not exactly 11 unique paths.",
    );
  }
  for (const trackedPath of M10A_T05_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT05SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated boundary omitted one exact M10A-T05 successor path.",
        { path: trackedPath },
      );
    }
  }
  const m10aT04SuccessorPaths = m10aT05SuccessorPaths.filter(
    (trackedPath) => !M10A_T05_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  const m10aT04SuccessorReview = calculateAffectedWorkloadOwnershipReview(m10aT04SuccessorPaths);
  if (!isDeepStrictEqual(m10aT04SuccessorReview, M10A_T04_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T05 append does not reproduce the reviewed M10A-T04 successor.",
    );
  }
  if (
    M10A_T04_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 22 ||
    new Set(M10A_T04_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 22
  ) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The reviewed M10A-T04 successor path append is not exactly 22 unique paths.",
    );
  }
  for (const trackedPath of M10A_T04_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT04SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated boundary omitted one exact M10A-T04 successor path.",
        { path: trackedPath },
      );
    }
  }
  const m10aT03SuccessorPaths = m10aT04SuccessorPaths.filter(
    (trackedPath) => !M10A_T04_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  const m10aT03SuccessorReview = calculateAffectedWorkloadOwnershipReview(m10aT03SuccessorPaths);
  if (!isDeepStrictEqual(m10aT03SuccessorReview, M10A_T03_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T04 append does not reproduce the reviewed M10A-T03 successor.",
    );
  }
  if (
    M10A_T03_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 43 ||
    new Set(M10A_T03_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 43
  ) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The reviewed M10A-T03 successor path append is not exactly 43 unique paths.",
    );
  }
  for (const trackedPath of M10A_T03_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT03SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated boundary omitted one exact M10A-T03 successor path.",
        { path: trackedPath },
      );
    }
  }
  const m10aT02SuccessorPaths = m10aT03SuccessorPaths.filter(
    (trackedPath) => !M10A_T03_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  const m10aT02SuccessorReview = calculateAffectedWorkloadOwnershipReview(m10aT02SuccessorPaths);
  if (!isDeepStrictEqual(m10aT02SuccessorReview, M10A_T02_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T03 append does not reproduce the reviewed M10A-T02 successor.",
    );
  }
  if (
    M10A_T02_SUCCESSOR_ADDED_TRACKED_PATHS.length !== 38 ||
    new Set(M10A_T02_SUCCESSOR_ADDED_TRACKED_PATHS).size !== 38
  ) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "The reviewed M10A-T02 successor path append is not exactly 38 unique paths.",
    );
  }
  for (const trackedPath of M10A_T02_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT02SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated boundary omitted one exact M10A-T02 successor path.",
        { path: trackedPath },
      );
    }
  }
  const m10aT01SuccessorPaths = m10aT02SuccessorPaths.filter(
    (trackedPath) => !M10A_T02_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
  const m10aT01SuccessorReview = calculateAffectedWorkloadOwnershipReview(m10aT01SuccessorPaths);
  if (!isDeepStrictEqual(m10aT01SuccessorReview, M10A_T01_SUCCESSOR_OWNERSHIP_REVIEW)) {
    fail(
      "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
      "Removing the exact M10A-T02 append does not reproduce the reviewed M10A-T01 successor.",
    );
  }
  for (const trackedPath of M10A_T01_SUCCESSOR_ADDED_TRACKED_PATHS) {
    if (!m10aT01SuccessorPaths.includes(trackedPath)) {
      fail(
        "AFFECTED_PROMOTION_OWNERSHIP_EQUIVALENCE_DRIFT",
        "The authenticated boundary omitted one exact pre-T02 successor path.",
        { path: trackedPath },
      );
    }
  }
  const promotedPaths = m10aT01SuccessorPaths.filter(
    (trackedPath) => !M10A_T01_SUCCESSOR_ADDED_TRACKED_PATHS.includes(trackedPath),
  );
...
async function createRunnerAuthority(workspaceRoot = WORKSPACE_ROOT, currentAuthority = undefined) {
  ...
  if (
    ...
    workflowSource.includes("timeout --signal=TERM --kill-after=30s 19m node") ||
...
export async function verifyAffectedSelectorPromotionEvidence(options = {}) {
  ...
  if (
    ...
    fail(
      ...
      "Current comparison-source receipts do not reproduce the reviewed AR-01 successor.",
    );
  }
  ...
  if (
    ...
    currentInventory.workloadCount !== 260 ||
    currentInventory.proofUnitCount !== 123
  ) {
    fail(
      "AFFECTED_PROMOTION_SUCCESSOR_AUTHORITY_DRIFT",
      "The current workload graph is not the exact reviewed M10A-T15 successor.",
    );
  }
  ...
  if (currentProofPairClasses.ordinary !== 108 || currentProofPairClasses.barrier !== 15) {
    fail(
      "AFFECTED_PROMOTION_SUCCESSOR_AUTHORITY_DRIFT",
      "The current M10A-T15 proof-pair authority is not exactly 108 ordinary and 15 barrier pairs.",
    );
  }
  ...
  if (
    ...
    archiveRedactionClosure.proofUnitCount !== 91 ||
    archiveRedactionClosure.workloadCount !== 196 ||
    archiveRedactionClosure.impactSha256 !==
      "5d12c4a8eab896391dbb13adfeee287dee835568ad0fa49cb2c3a1dada3b9bc3"
  ) {
    fail(
      "AFFECTED_PROMOTION_SUCCESSOR_AUTHORITY_DRIFT",
      "The current M10A-T15 successor closure from AR-01 is not exactly 91 proof units and 196 workloads.",
    );
  }
