...
const DIRECT_PROOF_VERIFIER_PREREQUISITES = SAFE_OBJECT_FREEZE({
  ...
  "desen-app-selection-overlay": SAFE_OBJECT_FREEZE([
    "node scripts/verify-desen-app-real-adapter-canvas.mjs",
  ]),
  "desen-app-schema-inspector": SAFE_OBJECT_FREEZE([
  ...
  "desen-app-structured-inspector": SAFE_OBJECT_FREEZE([
  ...
  "desen-app-source-persistence": SAFE_OBJECT_FREEZE([
    "node scripts/verify-desen-app-shell-navigation.mjs",
