...
export const INFRASTRUCTURE_DEBT_AUTHORITY = SAFE_OBJECT_FREEZE([
  ...
  authority(
    ...
    [
      ...
      target("tests/control-plane-bundle-verification.test.mjs", ["m07T09AppPackageBytes"]),
      target("scripts/lib/control-plane-package-preflight-proof.mjs", [
        "M07_T10_TRACKED_RECEIPT_BRIDGE",
      ...
      target("tests/control-plane-package-preflight.test.mjs", ["m07T09AppPackageBytes"]),
      target("scripts/lib/control-plane-reference-preflight-proof.mjs", [
