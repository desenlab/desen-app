...
- The fixed 53/32/38 partition executes 285 physical workloads, including replicated preparation
...
These are candidate execution contracts, not a claim that T15 has passed hosted closure.
