...
try {
  const result = await writeDesenAppBrowserE2eWorkspaceCompatibilityEvidence();
  process.stdout.write(
    `${JSON.stringify(
      {
        status: "PASS",
        ...result,
        message: "Wrote deterministic M10-T01 dedicated-workspace compatibility evidence.",
      },
      null,
      2,
    )}\n`,
