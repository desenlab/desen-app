...
6. run all 52 proof verifiers directly in the reviewed order, ending with the M06-T03 Source
   preflight proof;
7. run all 52 root proof and mutation files as separate fail-fast processes; and
8. run the dependency graph and hostile boundary fixtures.

The current legacy expansion contains 1,327 leaf process invocations but only 173 distinct
workloads. The optimized gate covers all 173 distinct workloads. Repeated prerequisite checks
...
- the 52 task IDs, verifier files, root test files, or their order;
- any of the 305 legacy prerequisite command segments;
- the exact 112-step normalized execution plan;
...
`sha256:09cf9fef57f53a7c0f3b2bde4b272c9a4447938f830fc44b05868d09d025e088`.
The ordered 1,327-entry legacy leaf-invocation inventory is pinned as
`sha256:a7a6124e826d5620dae68ea01c80b78eb925d3bde067aa3fe4305ab8f62b772e`; its sorted
173-entry distinct-workload inventory is pinned as
`sha256:6ed61432d2d4a44f6589006daed7d72a0fff9f35d21605b6a5011a6948ec7dc0`. The normalized
single-pass plan is pinned as
`sha256:e1356459312ca467e301ffdc20dda8d5735d25906fe9f08ee3aa730288471c3f`.
...
At the M06-T03 checkpoint, the frozen inventory contains 52 proofs, 305 prerequisite segments,
1,327 ordered leaf invocations, 173 distinct leaf workloads, and 112 normalized single-pass
steps. The prerequisite inventory is pinned as
`sha256:09cf9fef57f53a7c0f3b2bde4b272c9a4447938f830fc44b05868d09d025e088`; the other
