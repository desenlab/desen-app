...
Final receipt: `sha256:9d0f764e35f5400fa662874784fba6f6492a39a0e60557fe1a9c7d7eab5407c9`
...
boundary, disables cross-file/cache concurrency, and removes that config in `finally`. Before any
ignored build output exists, the CI contract preflight executes a dependency-free one-test Vitest
probe through the same launcher and exact isolation. The full T09 verifier remains authoritative
inside required-exhaustive execution after its build prerequisites; launcher, permission, or config
resolution drift therefore fails early without trusting a developer's local `dist` directories.
...
`ce12c066545e21779abf891898aaf0b09ceb1c0c1b51be382a0adabd5f86e939`. It leaves sequences
1–20 and every predecessor artifact byte unchanged, appends this 64,493-byte artifact, reseals 27
historical compatibility readers, and appends the 64,932-byte proof reader
`sha256:da3fed33227c78eef872d06a3aedaf98a4e87e91de12893a21aceb5a9365216f` plus the 17,341-byte root
reader `sha256:f50017b668eb7f4a60d596a2d87a7e5b067989a9e1fe9a00270e685c44a4b8f6`. The current chain
