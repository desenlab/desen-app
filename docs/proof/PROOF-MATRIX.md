...
| P-07 | Managed surfaces have no handwritten host component tree                                          | M05-T09, M09-T14, M10-T05                    | PROVEN         | M05-T09 discovers the complete independent-host production source inventory, resolves JSX and aliases through the TypeScript checker, and observes the real Vite production graph. Exact host-infrastructure JSX is allowlisted; the managed path reaches only the public generic runtime renderer and shared public adapter factory. Direct, aliased, namespace, helper-hidden, factory-created, plan-shaped, dynamically loaded, orphaned, and forbidden-data alternatives fail closed. M09-T14 keeps the Desen App browser production graph free of Node control-plane composition and reference-host server imports, while 2/2 focused real public integration cases compose the public control plane, fixed-channel adapter, and separately built reference host through a trusted-host boundary. M10-T05 adds the normal-product browser journey and fresh complete App/reference-host source, import, and Vite build audit. Two visible Save → Publish → Activate cycles change a managed Text label and Stack gap from revision A to B in the same independently built host; a second reload preserves B while the host source and served HTML/JavaScript/CSS identity remain unchanged. The current graphs contain 168 App modules / 510 static edges and 104 host modules / 299 static edges, no dynamic or unresolved edges, and 22 byte-identical managed modules shared by App and host.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Fulfilled: visible authored A → B update in one unchanged independently built host.                                                                   | `reference-host-web-0.1.0-source-audit.json` `sha256:cb54702266260a6e139950808b520bc139d35cebbde03ea93a187d2340a17e89`; `desen-app-0.1.0-publish-activation.json` `sha256:6bd2db0ca490f1d0046f145da7c4b7e9b4b25ec0f8295a159529a0e66534b23b`; `desen-app-0.1.0-published-host-update.json` `sha256:80c0b815a813ef462233b48a7fffe7c4d0bbf391aefc68eb9a6174da6bd84bd3`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 2026-09-04    |
| P-08 | A designer edits props, slots, state, bindings, and actions visually                              | M09-T05–M09-T14, M10-T01, M10-T01A, M10-T01B | PROVEN         | M09-T05 provides primitive/enum prop controls, M09-T06 adds recursive closed-object controls plus an explicit structured-JSON fallback, and M09-T07 adds Catalog-declared named-slot insertion, cross-slot move, same-slot reorder, and nested-subtree deletion. The T11 compatibility closure makes the dotted grip the actual draggable handle, admits the complete Components panel as the authenticated append surface, owns exactly one global slot/index projection across nested Layers drop surfaces, stabilizes midpoint jitter, uses release coordinates or the last admitted coordinate-less projection, auto-selects an inserted node, and keeps the guarded delete action immediately visible. The intervening T12 card-body/sticky-target-only behavior remains historical, and T13 restored dedicated grips, authenticated drop ownership, innermost-slot fencing, stable projection feedback, retained placement, and post-insertion focus. The current T14 compatibility repair enlarges the dedicated Layers and Components grips to `28 × 32 px` and `32 × 32 px` without layout shift; stable, non-overlapping, full-width `20 px` Layers lanes directly own boundary events with row-half fallback and innermost-slot fencing; the sticky Components `Drop target` directly owns drop while the authenticated panel remains a same-target fallback; and `Add` immediately selects the node beside the visible guarded `Remove layer` and Delete/Backspace paths. Named-slot/cardinality/validator authority is unchanged. At the M09-T14 checkpoint, automated native-drag/real-browser E2E remained open. M09-T08 adds deterministic surface-local primitive state list/add/update/delete, bounded conservative usage protection, exact direct Catalog-compatible local-state binding change/detach, and Publisher-atomic preview. Runtime namespaces and advanced dynamic bindings remain read-only. M09-T09 adds Catalog-declared component event projection, exact absent/empty/nonempty handler lifecycle, the closed seven-action union, recursive operation settlements, six public Editor Core edits, and Publisher-atomic preview. Behavior-owner UI remains unclaimed. M09-T10 adds one controlled same-session Design/Run boundary and a local `state.set` execution path, M09-T11 adds transient scenarios and synthetic operation lifecycle, and M09-T12 adds generation-guarded authored Source Open/Save through the injected public Editor Core port. Complete canonical Source content—not identity/version—controls dirty state; same-value/revert cleanliness, successful Open/Save baselines, current-vs-save-snapshot settlement, rerender-safe no-port projection, and the `Local draft unchanged` clean label are protected. Edited no-port and port-backed drafts are guarded across navigation/page exit. Exact own-enumerable settlement capture avoids accessors, freezes valid optional diagnostics, validates CAS relations, fails malformed Open/Save closed, and fences reentrant stale publication. M09-T13/T14 add diagnostics and saved-Source publication/activation. M10-T01 completes P-08 from an empty admitted project: the browser UI authors every claimed dimension; native Components/Layers drag succeeds; forged drag cannot mutate, with full canonical Source and persistence before/after equality; persisted Source revalidates; exact Design/Run parity holds. M10-T01A closes the normal-product reachability gap: the App starts with zero projects, visible New project → Blank sign-in project creation persists generation 1 through the real local control-plane port, visible authoring persists generation 2, and hard reload plus Projects-card reopen restore the exact Source. M10-T01B adds fail-closed visual connection, Catalog-aware action, visibility-predicate, and generic fixture controls so the same normal editor can author the behavior graph without mandatory JSON; its Chromium scenario repairs an invalid binding, types complete values, authors failure visibility, and observes pending fixtures. T02–T04 and G10 remain unproven. | Fulfilled: empty-project browser authoring, native drag, persisted validation, and exact Design/Run parity                                            | `desen-app-0.1.0-schema-inspector.json` `sha256:473ab3248ed7b7b4de0e558df47159a74c28c134b46569aa91130745fd69660b`; `desen-app-0.1.0-structured-inspector.json` `sha256:6ea4eb3f51fdfc39eeca676d7ebafb145d66a9efdfa03af9c33a7aa39aa6aaec`; `desen-app-0.1.0-named-slot-authoring.json` `sha256:daae817af45d8ead7052fd84df4edefd7d29cdd9ebe9cc1baea5b22b27dae90f`; `desen-app-0.1.0-state-binding-editor.json` `sha256:b7298375cba4b82258d1c293ecb66c3ae6641408ae9f5753da121ac44fcf601a`; `desen-app-0.1.0-event-action-editor.json` `sha256:0060ef39273ea36666f1701d5d3fa0f1610b95f40d88304ba980dcdc73cb29ab`; `desen-app-0.1.0-fixtures-scenarios-fidelity.json` `sha256:3f08980e687d48ba267f78c7d4dd1ae1eb59db5cc6bb3401d88705ee0416cc9d`; `desen-app-0.1.0-source-persistence.json` `sha256:717d0ddada008edb34909d5defcc4c28e95b36f6dfc0b1abb4d09d9775a6b734`; `desen-app-0.1.0-publish-activation.json` `sha256:6bd2db0ca490f1d0046f145da7c4b7e9b4b25ec0f8295a159529a0e66534b23b`; `desen-app-0.1.0-empty-project-browser-e2e.json` `sha256:959dde63ef28bc7fd25967a9193e39e082c9178bc12f40b83036c5dd6042df77`; `desen-app-0.1.0-browser-e2e-workspace-compatibility.json` `sha256:e90378e191fddea1264c8c056e2ff7a72fdfd945d1b1113465c12ddbffb1888d`; `desen-app-0.1.0-user-created-blank-project.json` `sha256:6277b82f22bf26e92b670164f2f1e2b7f861409f5b37585fb5053d88c4dadd2e`; `desen-app-0.1.0-visual-behavior-authoring.json` `sha256:cd7366014a0cb6f056fa78392f81ef7cb4b5be2f523b95e5984c704be3caf0e8` | 2026-08-31    |
| P-09 | Run Mode executes events, state, and operation lifecycle                                          | M09-T10, M10-T02–M10-T04                     | PROVEN         | M09-T10 proves the real Email adapter → Runtime React/Core → closed `state.set` path without Source/Bundle change or Runtime remount. M09-T11 adds exact synthetic lifecycle settlement and revocation. M10-T02 adds a real Chromium trace for complete plain/secure controlled input, one unresolved Runtime pending Promise, accessible Loading and repeat suppression, and input/pending continuity across Design/Run before generic terminal cleanup. M10-T03 adds the dedicated Chromium public-failure trace: the visible no-code flow authors a critical failed-status Alert; exact `invalidCredentials` settlement reveals it only after pending; a real retry hides and restores it; input, Loading cleanup, route, and `420 × 720` geometry remain stable. M10-T04 completes a visible two-surface Chromium journey: Synthetic success mounts the target with zero host calls; explicit Integration observes real local HTTP 401/200 and success navigation through the same Publisher/Runtime adapters. Source bytes, generation, entry and editor URL remain unchanged; restart, Design and reload restore the origin and saved empty input state.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Automated browser success trace plus real host-operation success and navigation                                                                       | `desen-app-0.1.0-design-run-modes.json` `sha256:bc5b7ffef0c39737882072f9340bcade86f084db8e7923fcb03aa7364d077334`; `desen-app-0.1.0-fixtures-scenarios-fidelity.json` `sha256:3f08980e687d48ba267f78c7d4dd1ae1eb59db5cc6bb3401d88705ee0416cc9d`; `desen-app-0.1.0-input-pending-fixture.json` `sha256:161202698b013775cbc89625ecea1f6894e9abcd927fb2eb660dff71652ba43d`; `desen-app-0.1.0-failure-fixture.json` `sha256:bde909f8dbc4837c70627bab454d3dc5a936bd0abb6d70ec22b9cffbdb0e6a20`; `desen-app-0.1.0-success-host-operation.json` `sha256:d9d841af06ec9efc51c3f1c74079f0aa4d5e1c7e996f3b97df7e277e4b1f8423`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 2026-09-03    |
| P-10 | Real host operations remain outside design documents                                              | M03-T08, M05-T08–M05-T09, M10-T04            | PROVEN         | Exact fixtures and the final Catalog remain inert data; the package surface exposes no loader while application code retains executable bindings. M05-T08/M05-T09 prove the reference-host boundary and resolved graph. M09-T11 adds only an App-owned synthetic port. M10-T02 proves in Chromium that outcome inventory derives from exact Source/Catalog authority, operation input is neither read nor retained, and Integration/Production remain unavailable. M10-T03 adds only the exact Catalog-declared synthetic `invalidCredentials` failure and keeps those real contexts disabled; it creates no live host authority. M10-T04 adds an opaque exact-profile host binding installed only by trusted composition, explicit Integration selection, real loopback HTTP 401/200 and managed navigation. Generic non-authentication and fixture-free operations, cancellation, replay, invalid output and stale authority are tested; documents select no endpoint, credential, handler or executable module. The local service is a test account, not production authentication.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Desen App real Run Mode host-operation execution                                                                                                      | `reference-sign-in-fixtures-and-host-binding.json` `sha256:b0413687bd907b71509db52d3e22b6eda5a4150509ac323bf51e5f8425f897e2`; `reference-catalog-web-capability-artifact.json` `sha256:4ddeee8d33ff718e1907a6402b7c2d10ef0769c872832a4cb056231441ae65e0`; `reference-host-web-0.1.0-sign-in.json` `sha256:a7c83d438190ee45dae4714bd092e56282cb3db4c69c72eeaca44e2647683adb`; `reference-host-web-0.1.0-source-audit.json` `sha256:cb54702266260a6e139950808b520bc139d35cebbde03ea93a187d2340a17e89`; `desen-app-0.1.0-fixtures-scenarios-fidelity.json` `sha256:3f08980e687d48ba267f78c7d4dd1ae1eb59db5cc6bb3401d88705ee0416cc9d`; `desen-app-0.1.0-input-pending-fixture.json` `sha256:161202698b013775cbc89625ecea1f6894e9abcd927fb2eb660dff71652ba43d`; `desen-app-0.1.0-failure-fixture.json` `sha256:bde909f8dbc4837c70627bab454d3dc5a936bd0abb6d70ec22b9cffbdb0e6a20`; `desen-app-0.1.0-success-host-operation.json` `sha256:d9d841af06ec9efc51c3f1c74079f0aa4d5e1c7e996f3b97df7e277e4b1f8423`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 2026-09-03    |
...
| P-12 | Invalid activation preserves last-known-good across restart                                       | M07-T07–M07-T11, M09-T14, M10-T07            | PROVEN         | M07 durable-role recovery and M09 fixed-channel publication remain in force. M10-T07 adds a normal-product Chromium journey that publishes visibly authored content, keeps corrupt-revision and Catalog-mismatch candidates selected, then restarts the complete service process under a new PID and fresh browser context. The unchanged host recovers the last authenticated revision and previous-good identity; a subsequent valid publication activates normally. The separate fresh public API matrix checks exact rejection stages and durable-role reconstruction. PR #82 and fresh main CI passed. Application-owned local storage remains trusted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | No hostile-admin, anti-rollback, remote, multi-tenant, production-authentication or native-platform claim. G10 consolidated closure remains separate. | `control-plane-api-0.1.0-runtime-activation.json` `sha256:3129a8e40c837a1c49d7fe206de794e0f7f7e130dc7e5e90a012b9e38bf07334`; `control-plane-api-0.1.0-runtime-recovery.json` `sha256:c65d4f2de1407fffb891b5d3ba2fc8a3a8d4e3f0fb76c8b8f2719be6b310b3f9`; `control-plane-api-0.1.0-runtime-fault-injection.json` `sha256:9d0f764e35f5400fa662874784fba6f6492a39a0e60557fe1a9c7d7eab5407c9`; `control-plane-api-0.1.0-runtime-transition-races.json` `sha256:f5f10dd422f9e1fc7ca4445b84bf192280e59fb747d8d2ed40357cba3ebc0f39`; `reference-host-web-0.1.0-channel-consumption.json` `sha256:48bd9f85bd2da413fc72c1973a33732cc091796f9afc2863ec1eec15054314e0`; `desen-app-0.1.0-publish-activation.json` `sha256:6bd2db0ca490f1d0046f145da7c4b7e9b4b25ec0f8295a159529a0e66534b23b`; `desen-app-0.1.0-last-known-good-recovery.json` `sha256:5e589bc8022de3ccf3add7a9ebab78006ecca6e72628e165f54eef4fd8b90b68`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 2026-09-08    |
...
dedicated checkpoint suite passes 82/82. The current neutral inventory contains 204 workloads and 97
...
## M10-T01A — Normal-product blank-project reachability

M10-T01A is an append-only reachability successor to M10-T01, not a second completion of the plan
task. It removes the fixture-bootstrap gap left by the historical T01 browser proof: the normal
`apps/desen-app/src/main.tsx` product entry now starts with zero projects, and a real Chromium
scenario uses only visible **New project** → **Blank sign-in project** controls to create the exact
admitted `account-app/sign-in` Source. The same visible authoring controls then add and order the
sign-in components, bind state, delete a transient Alert, save generation 2, hard reload, return to
Projects, and reopen the project and surface. The reopened canonical Source must equal the saved
Source exactly. Native Components and Layers drag are exercised; a forged `DataTransfer` drop
remains rejected.

The local product launcher binds only a fixed loopback address, generates a fresh bearer secret,
persists generation-guarded Source state beneath `.desen/desen-app/control-plane`, and serves the
production App bundle from the package root. Static resolution is fail-closed and cannot expose the
package `src`, repository, or persistence tree. The product entry receives the durable port through
explicit bootstrap composition rather than injected document or route authority. The focused
product/lifecycle suite passes 16/16, local-runtime persistence passes 17/17, the complete App suite
passes 407/407, the historical browser scenario passes 1/1, and the normal-product Chromium
scenario passes 1/1.

The deterministic evidence is the 20,173-byte
`docs/proof/artifacts/desen-app-0.1.0-user-created-blank-project.json` at
`sha256:6277b82f22bf26e92b670164f2f1e2b7f861409f5b37585fb5053d88c4dadd2e`. Its verifier passes,
its independent root suite passes 11/11, and its 43 exact receipts bind the normal entry, product
bootstrap, durable adapter and host, package ownership, focused tests, browser spec/config/server,
presentation boundary, immutable M10-T01-COMPAT prerequisite, passive proof readers, and the exact
13-file product-server boundary policy/fixture authority. The
artifact reader does not execute Chromium; browser execution remains owned by the dedicated
Browser E2E job. The historical 16,025-byte M10-T01-COMPAT artifact and 3,180-byte report remain
byte-identical.

Reader checkpoint sequence 61 preserves sequences 1–60, advances the exact sequence-60 head to
...
## M10-T01B — Visual behavior authoring

M10-T01B is an append-only usability successor to M10-T01A. It keeps the closed DESEN Source
grammar and public Editor Core command boundary while making the normal product capable of
authoring behavior without mandatory JSON. **Connect input** applies one exact controlled-value
binding plus `change → state.set(event.value)` recipe atomically; the connection projection admits
only the canonical three-field write and rejects conditional or extension-bearing near matches.
Catalog-aware visual action controls project component events, local state, operations, required
inputs, result aliases, and concurrency. Advanced JSON remains an explicit power-user escape hatch,
not a new action or execution authority. Visibility controls author always, operation-status,
local-state, or advanced predicates through public commands. Generic Run controls derive only the
operation aliases and inert fixtures declared by the admitted Source and Catalog; they do not infer
a sign-in product or create integration/production bindings.

The real Chromium scenario repairs a deliberately incomplete field binding through visible UI,
types complete multi-character values, authors an operation action and failed-operation visibility
without JSON, and observes a generic pending fixture lifecycle. The focused behavior suite passes
135/135 and the browser scenario passes 1/1. The deterministic 10,962-byte artifact is
`docs/proof/artifacts/desen-app-0.1.0-visual-behavior-authoring.json` at
`sha256:cd7366014a0cb6f056fa78392f81ef7cb4b5be2f523b95e5984c704be3caf0e8`. Its verifier passes,
its independent mutation suite passes 9/9, and its 31 exact receipts bind the immutable M10-T01A
predecessor, product sources, focused tests, browser declaration, Catalog/package/workflow
authority, and passive proof entrypoints. Fifteen historical App reader families authenticate this
exact successor; their combined suites pass 233/233 without rewriting any frozen predecessor
artifact.

Reader checkpoint sequence 64 preserves sequences 1–63, advances the exact sequence-63 head
`sha256:7245d3334dfaf801692783ed8a500ecc124ed259291ccf433cbc6fab21c76da7` to
`sha256:2590f7ebf99b927ccded490e511748e8e5abcf0a49108f67c78061aa021da5f0`, freezes 53 artifacts,
and authenticates 106 current readers. It reseals exact historical reader indexes `[70..97, 102,
...
`sha256:08be15b268b0aa9d86f1996ab9cb5be40cdffd57d5df4e70b39b529ae3cd9a78`. Required and shadow
exhaustive plans are respectively
`sha256:6376c330cc3bd4457b1474accd1f634a550eeed3bb949654bda8fce2217c8204` and
`sha256:8583bd13385342fbdc897c0215b67a802bf10db20f63c11eb7ef1e941e7774ec`.

The 99-proof impact graph is
`sha256:3edb1518a74a87c7bffd9a80b4c8c64c94eac6df35bbf66f1f465fb7df00aec5`; the terminal
M10-T01B closure contains 67 proof units and 144 workloads at
`sha256:16890d0b1fbf68372118deb35656055345a9d8ef9e699306fe338c2421091666`. Exact-one ownership
...
M10-T04 success/navigation and real host-operation closure, production integration, remote
deployment, or G10 completion. P-09 remains `PARTIAL`; no local receipt implies a hosted exact-head
CI pass.

## M10-T02 — Input and pending fixture

M10-T02 closes the dedicated complete-input and pending acceptance slice through the ordinary
Desen App product. The visible blank-project journey creates local state, two TextFields, and a
Button, connects complete controlled values, and maps Press to one Catalog operation without JSON.
One validated recipe captures the selected capability, collision-free result alias,
schema-compatible state inputs, explicit concurrency, and `operation.<alias>.pending` Loading
reference. A state is suggested automatically only for an exact input/state name match; schema
compatibility with a different name remains an explicit designer decision.

The authoring boundary defaults new connections to `reject`, repairs only one unambiguous root
invocation, and preserves unrelated action order, settlement branches, guard, and extensions.
Optional absent input remains absent. Existing declared or additional input values that visual
state controls cannot represent block Repair until an explicit safe replacement exists. Surface-wide
alias reservation prevents a selected component from reusing another owner's operation alias, and
multiple root invocations fail closed.

The focused 82/82 cases span the App connection, visual control, synthetic fixture, shared
TextField/Button, and Runtime operation-lifecycle boundaries. The 1/1 Chromium scenario uses
visible **Set Secure**, proves its checked Source state renders a native `type=password` field,
types both values incrementally, and observes a real unresolved Promise as synchronous Runtime
pending. It verifies accessible focused Button Loading and presses Enter while the Button is busy.
The scenario first confirms the default repeat policy, then chooses queue so a leaked activation would become
observable as a second pending invocation. Complete values and pending survive Design → Run.
Explicit fixture completion remains terminal across two animation frames before Loading cleanup is
asserted, so a delayed queued invocation cannot hide behind an immediate check. No Alert or
navigation is asserted.

The deterministic 14,261-byte / 25-receipt artifact is
`docs/proof/artifacts/desen-app-0.1.0-input-pending-fixture.json` at
`sha256:161202698b013775cbc89625ecea1f6894e9abcd927fb2eb660dff71652ba43d`. Its verifier passes,
and the independent root mutation reader passes 10/10. The artifact directly authenticates the
immutable 19,299-byte M10-T01C predecessor. A separately pinned 2,307,407-byte bounded canonical
gzip bridge at `sha256:16f6ec332fb03368e617563560b9930a7608594907ce61d5d15554be4dc7523d`
reconstructs exact task-time historical inputs without invoking the parent reader or rewriting a
frozen artifact.

The neutral CI inventory contains 212 workloads / 101 proof units. The M10-T02 App closure contains
69 proof units / 148 workloads, and exact-one ownership covers 1,366 tracked paths / 202
proof-owned paths. M10-T02 is `DONE`; implementation progress is 114/148 (77%), M10 is 5/12
(42%), and M10-T03 is next. Checkpoint sequence 67 preserves sequences 1–66 and closes its 55
artifacts / 110 readers at
`sha256:9ee6909c0f11ed7149cb9bf6ce1c7943ed99aac2d2c6f9138caea8f5dd2044b7`; the checkpoint suite
passes 90/90.

This evidence advances the P-09 browser lifecycle record but leaves P-09 `PARTIAL`: the selected
declared error proves only generic terminal fixture cleanup, while visible public failure remains
M10-T03 and success/navigation remains M10-T04. P-10 also remains `PARTIAL`; the synthetic
controller neither reads nor retains operation input, Integration and Production remain
unavailable, and a separately authorized real host operation remains M10-T04. N-036 and G10 remain
open. Local artifact, focused-test, and Chromium receipts make no hosted exact-head `Quality gate`
claim.

## M10-T03 — Failure fixture and visible public failure

M10-T03 closes the dedicated visible public-failure acceptance slice through the ordinary Desen App
product. Starting from the current authenticated profile's visible blank project, the designer uses
normal no-code controls to create controlled email and secure-password state, connect one Button to
the Catalog operation, and author a critical Alert whose complete visibility predicate follows
...
Only the exact Catalog-derived `error:invalidCredentials` fixture is selectable. `unavailable`
remains declared but has no invented fixture; Integration and Production remain visibly disabled.
The Alert is absent while idle and throughout the real unresolved Runtime pending interval. Explicit
settlement publishes the declared public failure, reveals the managed critical Alert, clears
accessible Button Loading, preserves both complete inputs, and keeps the route unchanged. A second
real invocation hides the prior Alert while pending and restores it only after the second declared
settlement. The `420 × 720` frame and horizontal document geometry remain stable throughout.
...
deterministic 16,868-byte / 34-receipt artifact is
...
authenticates the immutable 14,261-byte M10-T02 predecessor. The separately pinned 2,491,742-byte
T02 historical bridge at
`sha256:a3ef969f87441e2d8079dc7cd27db3a759acbb645441d206c3b35adc3149ec10` reconstructs
3,728,371 bytes and 25 task-time files from exact base
`d2c632f2cacab5d316d57aa3d51758d2a76d3cd2` without rewriting the predecessor.

The neutral CI inventory contains 214 workloads / 102 proof units at
`sha256:c1cec82a944152060e00caa1ad6f500c7f7e391d7056fe84f61967aef62ef947`. The impact graph is
`sha256:91645dd903e4ade7f10f54dd6b07c65a49b355921a35946ee305ee9782aad0ee`; the M10-T03
...
`sha256:903c1fabc314e2558e05aff85b810d279b045efdfd52494c2f08b281808533db`. The selector and runner
authorities are respectively
`sha256:cb0638a65d9ba9bfcfecb780921a195da4c19de5af9512fb2a5169ecbf18fb2f` and
`sha256:ba00d7c81ca4392d50b0fc869434d531acd82a949cde376de051f93261e6f723`.

Checkpoint sequence 68 preserves sequences 1–67 and closes 56 artifacts / 112 readers at
`sha256:e685779412ca17b76c78a56ff545bbff5a7fc5efc8bc564247cc49e7c54eeca8`; its suite passes
91/91.

M10-T03 is `DONE`; implementation progress is 115/148 (78%), M10 is 6/12 (50%), and M10-T04 is
next. This adds the required automated browser failure trace to P-09, but P-09 remains `PARTIAL`
until M10-T04 supplies success and navigation. P-10 also remains `PARTIAL`: success and a separately
authorized real host operation remain M10-T04. Integration, Production, N-036, remote or multi-user
execution, and G10 remain open. Local artifact, focused-test, and Chromium receipts make no hosted
exact-head `Quality gate` claim.

## M10-T04 — Success, transient navigation, and an explicit real host connection

P-09 and P-10 advance to `PROVEN` for their stated App lifecycle and host-separation claims. The
normal product's authenticated workspace chooser admits an independent blank Flow app with Start
and Result surfaces, without migrating existing Account app Source. The Chromium journey authors
both pages, controlled inputs, a non-default operation alias, a conditional Alert and Success →
Navigate entirely through visible controls.

Synthetic success mounts the authored target with zero host requests. Explicit Integration invokes
the same separate loopback HTTP operation service installed by the normal launcher: a real 401
keeps the origin and its failure visible; a real 200 returns `local-host-user`, distinct from the
Catalog fixture, and mounts the target through the same Publisher/Runtime adapters. The browser
observes rather than intercepts transport. Exact saved Source bytes, generation, entry and editor
URL remain unchanged across Run; Design/restart/reload restore the authoring origin and saved empty
input state.

Only trusted composition can install the opaque exact-profile binding. Alias, capability, effect,
preview context, activation epoch and replay admission protect each invocation. Focused tests cover
generic non-authentication and fixture-free operations, malformed output, cancellation, late
responses and rejected authority. Documents never select endpoints, credentials, handlers or code.
The local service is a test account, not production authentication; Production remains disabled.

Local execution passes 611/611 complete App cases, all five Chromium journeys, 177/177 focused T04
cases (App 141, Runtime 36), and 10/10 independent root cases. The deterministic reader separately
binds 125 declaration sites and 51 exact receipts. Its 22,456-byte artifact is
...
The bounded 2,769,997-byte T03 bridge at
`sha256:64f76eaeac8369a9f7ae00086dac914adc3c84979d53c770d2ebe0082576005f` reconstructs 34
exact T03 files plus eight authenticated historical-reader gaps without modifying predecessor
artifacts. Positive no-op and path-specific negative controls ensure that historical mutation
checks reject the intended change instead of an incidental live-file mismatch.

Checkpoint sequence 69 preserves sequences 1–68 and all 56 predecessor artifacts, reseals the T01A
and T01C libraries plus the two T03 readers (indices 102, 106, 110, 111), and adds the T04 artifact
and two readers (indices 112, 113). Its 57-artifact / 114-reader head is
`sha256:535a09b42d158f9bdf934924f704f3fb278d68da84a3dcbbfa32e38cee375c61`.

The T04 `DONE` entry remains a closure candidate until this exact PR head's hosted `Quality gate`
passes; local evidence does not authorize merge. Progress is 116/148 (78%), M10 is 7/12 (58%), and
T05 remains `NOT_STARTED` and next. P-07/T05 publish-and-activate, T07 recovery, P-12, N-036,
production or multi-user deployment, and G10 retain their existing owners. ADR 0017 and
`docs/proof/DESEN-APP-SUCCESS-HOST-OPERATION.md` record the full decision and bounded evidence.

## M10-T05 — Published label and layout update in an unchanged host

P-07 advances to `PROVEN` for the audited Web–React profile. The normal product creates a blank
Account project and uses visible Inspector controls for two Save → Publish → Activate cycles. The
separately built reference host mounts revision A, then after reload shows revision B's changed Text
label and Stack gap; a second reload preserves B. The served host HTML, JavaScript, CSS, and complete
source identity remain unchanged across both activations. Source and Catalog data cannot select the
fixed channel, host, endpoint, bearer, activation callback, server implementation, or executable
module.

The task verifier passes, the independent root mutation reader passes 10/10, focused suites pass
74/74, 18/18, 35/35, and 31/31, and the dedicated Chromium journey passes 1/1. The deterministic
reader binds 66 declaration sites separately from actual execution. Two fresh Vite 8.1.5
`build({ write: false })` observations for each application close at 168 App modules / 510 static
edges and 104 host modules / 299 static edges, with no dynamic or unresolved edges and 22
byte-identical transformed managed modules shared by the App and host. Dependency boundaries pass
across 861 modules / 3,685 dependencies.

The immutable 189,123-byte artifact contains 116 tracked receipts at
...
paths. PF-059 closes for this exact App/reference-host graph. Progress advances to 117/148 (79%),
M10 advances to 8/12 (67%), and proof gates remain 11/13. M10-T06 is next. Invalid publication,
T07 last-known-good recovery, production identity, remote or multi-user deployment, native targets,
P-12, N-036, and G10 remain open. The T05 `DONE` entry is a closure candidate until fresh hosted
...
It records 41 current tracked receipts and fresh unprojected App/host graphs. P-12 is `PROVEN`:
[PR #82](https://github.com/desenlab/desen-app/pull/82) passed exact-head
[PR CI](https://github.com/desenlab/desen-app/actions/runs/34215082332) at
`786b2ebbf8facee5128559373ff4a23c225b8623`; its identical merged tree at
`6cd7c8454f780d59ba88180a7556a1e063716597` passed
[fresh main CI](https://github.com/desenlab/desen-app/actions/runs/34216545093), including all
eight Chromium journeys, three exhaustive shards and the joined Quality gate.
PF-077/PF-090 stay `OPEN` for their general transport/project-model questions;
...
## M10-T08 repeatable normal-product demo

The [runbook](../plan/DEMO-RUNBOOK.md) and [evidence report](DESEN-APP-REPEATABLE-DEMO.md)
join visible Flow authoring, Synthetic and explicit Integration, publication, and the independent
host through the ordinary product. `pnpm demo:reset` starts empty owned storage on 5173; normal
projects stay unchanged and one prior demo generation is retained. No prepared positive Source
or handwritten managed tree is introduced. Two complete visible authoring cycles reproduce exact
Source/Bundle bytes, and later label/layout publications preserve host HTML/assets within startup.
