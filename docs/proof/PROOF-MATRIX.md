...
| P-12 | Invalid activation preserves last-known-good across restart                                       | M07-T07–M07-T11, M10-T07                    | NOT_PROVEN     | M07-T07 commits active, previous-good, and generation as one atomic record. M07-T08 reconstructs runtime authority only after the durable active and optional previous-good roles independently pass exact M07-T03 authority authentication, fresh M07-T04/M07-T06 work, same-store complete-Bundle reclosure, and a final equality check across all three durable fields. M07-T09 executes a closed 19-case boundary-fault matrix: definite precommit rejection preserves A, recovery rejection publishes neither role, and an indeterminate post-COMMIT outcome requires complete winner reconstruction. M07-T10 adds a closed valid A → invalid B → valid C matrix, one-winner same/different-candidate compare-and-swap races, generation fencing with fresh-staging retry, both recovery/activation interleavings, exact restart reconstruction, and fail-closed SQLite profile reauthentication. Invalid B never becomes memory or durable authority, later valid C records A as previous-good, and restart publishes only the exact durable winner. The local root remains trusted and no tamper-proof or anti-rollback claim is made.                                                                       | M07-T11 must prove mutable-channel consumption by the separately built reference host without treating discovery as authority; M10-T07 must prove product-level restart preservation. | `control-plane-api-0.1.0-runtime-activation.json` `sha256:3129a8e40c837a1c49d7fe206de794e0f7f7e130dc7e5e90a012b9e38bf07334`; `control-plane-api-0.1.0-runtime-recovery.json` `sha256:c65d4f2de1407fffb891b5d3ba2fc8a3a8d4e3f0fb76c8b8f2719be6b310b3f9`; `control-plane-api-0.1.0-runtime-fault-injection.json` `sha256:9d0f764e35f5400fa662874784fba6f6492a39a0e60557fe1a9c7d7eab5407c9`; `control-plane-api-0.1.0-runtime-transition-races.json` `sha256:f5f10dd422f9e1fc7ca4445b84bf192280e59fb747d8d2ed40357cba3ebc0f39`                                                                                           | 2026-08-10    |
