...
| P-08 | A designer edits props, slots, state, bindings, and actions visually                              | M09-T05–M09-T09, M10-T01                    | NOT_PROVEN     | M09-T05 provides primitive/enum prop controls, M09-T06 adds recursive closed-object controls plus an explicit structured-JSON fallback, and M09-T07 adds Catalog-declared named-slot insertion, cross-slot move, same-slot reorder, and nested-subtree deletion. Its UX compatibility closure uses a root-safe Components default plus explicit target change, enlarged non-overlapping Layers lanes with the last valid row projection retained through drop, insert auto-selection, a visible safe Delete action, and guarded Delete/Backspace shortcuts outside editable controls; named-slot/cardinality/validator authority is unchanged and native real-browser drag E2E remains open. M09-T08 adds deterministic surface-local primitive state list/add/update/delete, bounded conservative usage protection, exact direct Catalog-compatible local-state binding change/detach, and Publisher-atomic preview. Runtime namespaces and advanced dynamic bindings remain read-only. M09-T09 adds Catalog-declared component event projection, exact absent/empty/nonempty handler lifecycle, the closed seven-action union, recursive operation settlements, six public Editor Core edits, and Publisher-atomic preview. Behavior-owner UI remains unclaimed. M09-T10 adds one controlled same-session Design/Run boundary and a local `state.set` execution path, but durable persistence, publication/activation, and automated real-browser E2E remain unproven. | Desen App browser E2E from an empty project                                                                                       | `desen-app-0.1.0-schema-inspector.json` `sha256:473ab3248ed7b7b4de0e558df47159a74c28c134b46569aa91130745fd69660b`; `desen-app-0.1.0-structured-inspector.json` `sha256:6ea4eb3f51fdfc39eeca676d7ebafb145d66a9efdfa03af9c33a7aa39aa6aaec`; `desen-app-0.1.0-named-slot-authoring.json` `sha256:daae817af45d8ead7052fd84df4edefd7d29cdd9ebe9cc1baea5b22b27dae90f`; `desen-app-0.1.0-state-binding-editor.json` `sha256:b7298375cba4b82258d1c293ecb66c3ae6641408ae9f5753da121ac44fcf601a`; `desen-app-0.1.0-event-action-editor.json` `sha256:0060ef39273ea36666f1701d5d3fa0f1610b95f40d88304ba980dcdc73cb29ab`                                                                                                                  | 2026-08-29    |
| P-09 | Run Mode executes events, state, and operation lifecycle                                          | M09-T10, M10-T02–M10-T04                    | PARTIAL        | M09-T10 proves one exact controlled path: the real Email adapter event crosses public Runtime React into Runtime Core, executes the Source's closed `state.set` action, updates Runtime-local state, and rerenders the same managed subtree without changing Source or Bundle revision or remounting the session. Design remains interaction-disabled, Run centrally rejects authoring, and all external host ports remain denied or inert. Operation pending/success/failure lifecycle, fixtures, scenarios, and automated browser E2E remain unproven.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Pending/success/failure observable trace and UI tests                                                                             | `desen-app-0.1.0-design-run-modes.json` `sha256:0c0c5450b32bc1e841cc046f49a8eb9a48dfee512b1c83186ed549aa3a5ebe03`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 2026-08-29    |
...
at `sha256:58c9969adde3240c05bc41e3d56214054bc8a5145998e47e93e16fc077e61962`.
