...
| P-08 | A designer edits props, slots, state, bindings, and actions visually                              | M09-T05–M09-T09, M10-T01                    | NOT_PROVEN     | M09-T05 provides schema-derived primitive/enum prop controls for the exact selected Source component. Public Editor Core mutation, continuous validation, Publisher preflight, and atomic session-local Source/preview replacement are locally evidenced. Dynamic values and structured descriptors remain locked. Slots, state, bindings, actions, Design/Run, persistence, and browser E2E remain unproven.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Desen App browser E2E from an empty project                                                                                       | `desen-app-0.1.0-schema-inspector.json` `sha256:473ab3248ed7b7b4de0e558df47159a74c28c134b46569aa91130745fd69660b`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 2026-08-28    |
