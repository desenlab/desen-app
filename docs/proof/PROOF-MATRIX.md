...
| P-12 | Invalid activation preserves last-known-good across restart                                       | M07-T07–M07-T11, M10-T07                    | NOT_PROVEN     | M07-T07 commits active, previous-good, and generation as one atomic record. M07-T08 reconstructs runtime authority only after the durable active and optional previous-good roles independently pass exact M07-T03 authority authentication, fresh M07-T04/M07-T06 work, same-store complete-Bundle reclosure, and a final equality check across all three durable fields. M07-T09 executes a closed 19-case matrix across channel discovery, immutable fetch, integrity, package resolution, reference preflight, staging, durable commit, and restart recovery. Every definite precommit rejection publishes no candidate authority and preserves the exact durable A record; recovery rejection publishes neither durable role, while a post-COMMIT indeterminate result publishes no authority until a fresh controller recovers the complete durable winner. The local root remains trusted and no tamper-proof or anti-rollback claim is made.                                                                                                                                                                                                                                                                | M07-T10, M07-T11, and M10-T07 must still prove A → invalid B → valid C, concurrency/race and restart behavior, separately built host consumption, and product-level restart preservation. | `control-plane-api-0.1.0-runtime-activation.json` `sha256:3129a8e40c837a1c49d7fe206de794e0f7f7e130dc7e5e90a012b9e38bf07334`; `control-plane-api-0.1.0-runtime-recovery.json` `sha256:c65d4f2de1407fffb891b5d3ba2fc8a3a8d4e3f0fb76c8b8f2719be6b310b3f9`; `control-plane-api-0.1.0-runtime-fault-injection.json` `sha256:524a9a4be5af6f334dc643272b2268fae63207c6e7bed3f2f688d2e778caf6a1`                                                                                                                                                                                                                              | 2026-08-07    |
