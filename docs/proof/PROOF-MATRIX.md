...
| P-11 | Authoring-only state does not enter production bundles                                            | M06-T07–M06-T10                             | PARTIAL        | M06-T07 calculates the exact authenticated Source digest with only root `authoring` excluded, then removes that root member before producing the detached deterministic normalized production-document base. Root-authoring changes affect neither digest nor normalized bytes, while nested extension content remains significant.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | M06-T08–M06-T10 must still prove the exact pinned requirements, complete validated Bundle, revision, and golden double-publication boundary. | `publisher-0.1.0-source-normalization.json` `sha256:f9859ead492b1b24b99b7bdd324c2a0b4dab60aef3cd43e60a2240d1f6418b4c`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | 2026-07-29    |
...
M06-T08 must authenticate and carry that exact value while replacing loose requirements with exact
Catalog tuples.
...
P-11 advances only to `PARTIAL`. P-03 remains `NOT_PROVEN`, P-05 remains `PARTIAL`, N-018 remains
`PLANNED`, and no proof gate changes. Exact tuple pinning, terminal Bundle validation, revision,
and golden double-publication evidence remain M06-T08 through M06-T10.
