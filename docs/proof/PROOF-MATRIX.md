...
protect the platform-neutral boundary. Variant and materialized-operand composition remains
M04-T05; reactive absent-subtree lifecycle remains M04-T15/M04-T16, so P-17 remains `PARTIAL` and
no proof gate advances:
