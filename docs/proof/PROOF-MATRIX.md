...
| P-08 | A designer edits props, slots, state, bindings, and actions visually                              | M09-T05–M09-T09, M10-T01                    | NOT_PROVEN     | M09-T05 provides primitive/enum prop controls, M09-T06 adds recursive closed-object controls plus an explicit structured-JSON fallback, and M09-T07 adds Catalog-declared named-slot insertion, cross-slot move, same-slot reorder, and nested-subtree deletion. Exact current-Source reauthorization, slot acceptance and effective min/max cardinality, public Editor Core mutation, complete validation, Publisher preflight, atomic session-local Source/preview commit, and App-owned keyboard/click/drag-intent controls are locally evidenced. Dynamic state, bindings, events, actions, Design/Run, durable persistence, publication/activation, and real-browser E2E remain unproven.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Desen App browser E2E from an empty project                                                                                       | `desen-app-0.1.0-schema-inspector.json` `sha256:473ab3248ed7b7b4de0e558df47159a74c28c134b46569aa91130745fd69660b`; `desen-app-0.1.0-structured-inspector.json` `sha256:6ea4eb3f51fdfc39eeca676d7ebafb145d66a9efdfa03af9c33a7aa39aa6aaec`; `desen-app-0.1.0-named-slot-authoring.json` `sha256:daae817af45d8ead7052fd84df4edefd7d29cdd9ebe9cc1baea5b22b27dae90f`                                                                                                                                                                                                                                                                                                                                                               | 2026-08-28    |
...
and the current model determine the actual edit. Expanded, overlapping slot boundaries and
depth-counted hover state improve Layers targeting across nested descendants. Components exposes
one explicit selected-slot target, or disables dragging and guides the user back to Layers when no
slot is selected. Native keyboard and click controls preserve insertion and placement fallbacks.
All chrome and drag state remain outside the managed Runtime React capability subtree.
...
subtree continue to fail closed. M09-T08 is next.
