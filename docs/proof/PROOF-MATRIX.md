...
| P-10 | Real host operations remain outside design documents                                              | M03-T08, M05-T08–M05-T09, M10-T04           | PARTIAL        | Exact fixtures and the final Catalog remain inert data; the exact package surface exposes no loader while application code retains the executable binding. M05-T08 now executes the official-derived Bundle through a fixed same-origin host operation whose capability, alias, effect, input shape, response budget, and navigation policy are outside the Bundle and fail closed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | M05-T09 final source/import audit plus Desen App Run Mode operation execution                                         | `reference-sign-in-fixtures-and-host-binding.json` `sha256:b0413687bd907b71509db52d3e22b6eda5a4150509ac323bf51e5f8425f897e2`; `reference-catalog-web-capability-artifact.json` `sha256:4ddeee8d33ff718e1907a6402b7c2d10ef0769c872832a4cb056231441ae65e0`; `reference-host-web-0.1.0-sign-in.json` `sha256:a7c83d438190ee45dae4714bd092e56282cb3db4c69c72eeaca44e2647683adb`                                                                                                     | 2026-07-28    |
...
This strengthens P-06 and P-10 but leaves both `PARTIAL`. P-07 remains `NOT_PROVEN` until the
M05-T09 AST and real resolved-import-graph audit; P-17 remains `PARTIAL`, N-036 remains `PLANNED`,
and G05 remains open. The fixture is not claimed as M06 Publisher output, and this is not a
real-browser, Desen App, backend, native-runtime, or deployment-security proof.
