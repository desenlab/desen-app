...
| P-11 | Authoring-only state does not enter production bundles                                            | M06-T07–M06-T10                             | PARTIAL        | M06-T07 calculates the exact authenticated Source digest with only root `authoring` excluded, then removes that root member before producing the detached deterministic normalized production-document base. M06-T08 independently authenticates that digest and constructs an exact pinned document whose root has no `authoring`; root-authoring-only changes affect neither digest nor pinned document, while nested extension content remains significant. M06-T09 carries that authoring-free authority into the complete independently validated Bundle, proves final canonical-byte enforcement and revision closure, and never adds `publication` metadata.                                                                                                                                                                                                                                                               | M06-T10 must still prove the frozen official golden and two independent byte-identical public publications.           | `publisher-0.1.0-source-normalization.json` `sha256:59cb08f75849ae4831644e746a72186227a9774ceb7bcd8281156ccbc6dd085e`; `publisher-0.1.0-catalog-pinning.json` `sha256:de37aa35bcdc67e637d323a559f104160479315f56961c962e00bfdc74459c8f`; `publisher-0.1.0-bundle-publication.json` `sha256:2942aa84066354ee7c27557263a900eb8fd3a149d085ab55c7f880dcfca998df`                                                                                                                                                                                                                                            | 2026-07-29    |
