...
| P-08 | A designer edits props, slots, state, bindings, and actions visually                              | M09-T05–M09-T09, M10-T01                    | NOT_PROVEN     | M09-T05 provides primitive/enum prop controls and M09-T06 adds recursive closed-object controls plus an explicit structured-JSON fallback for the exact selected Source component. Exact RFC 6901 authorization, Publisher-profile strict JSON, continuous validation, Publisher preflight, and atomic session-local Source/preview replacement are locally evidenced. Dynamic values, slots, state, bindings, actions, Design/Run, persistence, and browser E2E remain unproven.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Desen App browser E2E from an empty project                                                                                       | `desen-app-0.1.0-schema-inspector.json` `sha256:473ab3248ed7b7b4de0e558df47159a74c28c134b46569aa91130745fd69660b`; `desen-app-0.1.0-structured-inspector.json` `sha256:6ea4eb3f51fdfc39eeca676d7ebafb145d66a9efdfa03af9c33a7aa39aa6aaec`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 2026-08-28    |
