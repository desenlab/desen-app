...
## M10A product foundation — T01 through T10 complete; T11 integration-ready
...
application-owned project/surface lifecycle and generation-fenced storage only. M10A-T11 is
`IN_PROGRESS`: its local App boundary adds bounded direct manipulation, accessible canvas chrome,
and atomic slot-aware group placement; hosted closure remains required. Neither task adds Runtime,
