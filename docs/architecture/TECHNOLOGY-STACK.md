...
## M10A product foundation — T01 through T10 complete; T11 next
...
application-owned project/surface lifecycle and generation-fenced storage only; it adds no Runtime,
