...
## M10A product foundation — T01 through T06 complete; T07 dependency-ready
...
`DONE` with exact-head hosted and fresh-`main` form-control closure. M10A-T07 is dependency-ready
but `NOT_STARTED`; M11 has not started.
