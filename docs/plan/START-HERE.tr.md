...
normal projeler korunur, yalnızca özel demo verisi sıfırlanır ve son kopyası tutulur. Görev tablosundaki
`DONE` koşullu kapanış adayıdır: tam güncel PR, merge ve taze main geçmeden T09'a başlanmaz.
