...
Devam eden M10A-T06 görevini sürdürmek için:

> Yukarıdaki kurallarla yalnız `M10A-T06` görevini uygula. Önce M10A-IMPLEMENTATION-PLAN,
> M10A-TASK-CONTRACTS, ADR 0023 ve tamamlanmış T01–T05 kanıtlarını oku. T01'in Base UI adaptör
...
> şu anda `IN_PROGRESS` durumundadır; açık kapsamı genişletme veya hosted closure olmadan durumunu
> `DONE` yapma. Devam ederken tam güncel PR head'inin hosted Quality gate'i geçmeden görevi `DONE`
> yapma.
