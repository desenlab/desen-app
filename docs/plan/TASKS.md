...
M10A-T04 is `IN_PROGRESS` with local implementation/evidence; exact-head hosted closure remains
pending. The [plan](M10A-IMPLEMENTATION-PLAN.md) and
...
| M10A-T04 | IN_PROGRESS | M10A-T02                                         | Immutable design-system releases and host snapshot identity                            |
