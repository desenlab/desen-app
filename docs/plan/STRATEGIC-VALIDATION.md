...
authority. T13 through T17 add no Runtime, Publisher, Core/protocol, G10A, or M11 authority; T16 and T17 are `DONE` with hosted exact-head and fresh-`main` closure, T18 is selected next and `NOT_STARTED`, while T19 is also dependency-ready but unselected. G10A must pass before M11-T01 or M11-T08, and SC-02
